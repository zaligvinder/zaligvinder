...
RUN wget -O /tools/cvc4/cvc4 https://github.com/CVC4/CVC4/releases/download/1.8/cvc4-1.8-x86_64-linux-opt && chmod +x /tools/cvc4
...
RUN echo -e '{\n"Binaries" : {\n"Z3Bin" : {\n"path" : "/tools/z3/z3-4.8.10-x64-ubuntu-18.04/bin/z3"\n},\n"cvc4" : {\n"path" : "/tools/cvc4/cvc4"\n}\n}\n}' > /zaligvinder/toolconfig.json