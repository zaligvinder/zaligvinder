...
(assert (not (str.in.re (str.++ var_9 "a" "z" var_10 ) (re.++ (re.* (str.to.re "z")) (re.union (str.to.re "") (re.++ (re.union (str.to.re "b") (re.union (str.to.re "a") (str.to.re "c"))) (re.* (re.union (str.to.re "b") (re.union (str.to.re "a") (str.to.re "c"))))))))))
(check-sat)
