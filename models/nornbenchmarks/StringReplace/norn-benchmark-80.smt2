...
(assert (not (str.in_re (str.++ var_9 "a" "z" var_10 ) (re.++ (re.* (re.union (str.to_re "z") (re.++ (re.union (str.to_re "a") (str.to_re "c")) (re.++ (re.* (str.to_re "z")) (re.union (str.to_re "a") (str.to_re "c")))))) (re.++ (re.union (str.to_re "a") (str.to_re "c")) (re.* (str.to_re "z")))))))
(check-sat)
