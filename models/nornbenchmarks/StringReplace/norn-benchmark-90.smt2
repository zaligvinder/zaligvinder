...
(assert (str.in_re (str.++ var_9 "z" "b" var_10 ) (re.++ (re.* (str.to_re "z")) (re.union (str.to_re "") (re.++ (re.union (str.to_re "b") (re.union (str.to_re "a") (str.to_re "c"))) (re.* (re.union (str.to_re "a") (str.to_re "c"))))))))
