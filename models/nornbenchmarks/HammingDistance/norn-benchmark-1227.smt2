...
(assert (str.in_re (str.++ var_4 "z" var_5 ) (re.++ (re.* (re.union (re.union (str.to_re "z") (str.to_re "b")) (re.++ (str.to_re "a") (re.++ (re.* (str.to_re "b")) (str.to_re "z"))))) (re.++ (str.to_re "a") (re.* (str.to_re "b"))))))
