...
(assert (str.in.re (str.++ var_4 "z" var_5 ) (re.++ (re.* (re.union (str.to.re "z") (re.++ (re.union (str.to.re "b") (str.to.re "a")) (re.++ (re.* (str.to.re "b")) (str.to.re "a"))))) (re.++ (re.union (str.to.re "b") (str.to.re "a")) (re.* (str.to.re "b"))))))
