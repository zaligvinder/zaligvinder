...
(assert (str.in_re (str.++ var_4 "z" var_5 ) (re.++ (re.* (re.union (str.to_re "z") (re.++ (re.union (str.to_re "b") (str.to_re "a")) (re.++ (re.* (str.to_re "b")) (str.to_re "a"))))) (re.++ (re.union (str.to_re "b") (str.to_re "a")) (re.* (str.to_re "b"))))))
