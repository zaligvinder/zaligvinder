...
(assert (not (str.in.re (str.++ "a" var_9 "z" "b" var_10 ) (re.* (re.union (str.to.re "a") (re.++ (re.union (str.to.re "z") (str.to.re "b")) (re.++ (re.* (str.to.re "b")) (re.union (str.to.re "z") (str.to.re "a")))))))))
