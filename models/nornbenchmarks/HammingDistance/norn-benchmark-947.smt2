...
(assert (not (str.in_re (str.++ "a" var_9 "z" "b" var_10 ) (re.* (re.union (str.to_re "a") (re.++ (re.union (str.to_re "z") (str.to_re "b")) (re.++ (re.* (str.to_re "b")) (re.union (str.to_re "z") (str.to_re "a")))))))))
