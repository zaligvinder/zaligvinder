...
(assert (str.in.re (str.++ var_8 "z" var_9 ) (re.++ (re.* (re.union (re.union (str.to.re "z") (str.to.re "b")) (re.++ (str.to.re "a") (re.++ (re.* (str.to.re "b")) (str.to.re "z"))))) (re.++ (str.to.re "a") (re.* (str.to.re "b"))))))
