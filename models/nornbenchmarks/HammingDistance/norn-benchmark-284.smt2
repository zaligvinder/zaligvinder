...
(assert (str.in.re (str.++ var_4 "z" var_5 ) (re.++ (re.* (re.union (re.union (str.to.re "z") (str.to.re "b")) (re.++ (str.to.re "a") (re.++ (re.* (re.union (str.to.re "z") (str.to.re "a"))) (str.to.re "b"))))) (re.++ (str.to.re "a") (re.* (re.union (str.to.re "z") (str.to.re "a")))))))
