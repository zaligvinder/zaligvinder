...
(assert (not (str.in.re (str.++ var_7 "z" var_8 "a" ) (re.* (re.union (str.to.re "a") (re.++ (re.union (str.to.re "z") (str.to.re "b")) (re.++ (re.* (str.to.re "b")) (re.union (str.to.re "z") (str.to.re "a")))))))))
