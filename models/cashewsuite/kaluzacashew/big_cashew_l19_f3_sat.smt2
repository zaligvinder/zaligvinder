...
(assert (not (str.in_re v31 (str.to_re "D"))))
(assert (not (str.in_re v99 (str.to_re "#"))))
(assert (not (str.in_re v86 (str.to_re "B"))))
(assert (not (str.in_re v30 (str.to_re "E"))))
(assert (not (str.in_re v87 (str.to_re "C"))))
