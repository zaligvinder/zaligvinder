...
(assert (not (str.in.re v39 (str.to.re "D"))))
...
(assert (not (str.in.re v108 (str.to.re "B"))))
(assert (not (str.in.re v113 (str.to.re "B"))))
(assert (not (str.in.re v117 (str.to.re "B"))))
(assert (not (str.in.re v38 (str.to.re "E"))))
(assert (not (str.in.re v40 (str.to.re "E"))))
(assert (not (str.in.re v44 (str.to.re "E"))))
(assert (not (str.in.re v109 (str.to.re "C"))))
