...
(assert (not (str.in.re v34 (str.to.re "D"))))
...
(assert (not (str.in.re v38 (str.to.re "D"))))
(assert (not (str.in.re v114 (str.to.re "#"))))
(assert (not (str.in.re v97 (str.to.re "B"))))
(assert (not (str.in.re v102 (str.to.re "B"))))
(assert (not (str.in.re v33 (str.to.re "E"))))
(assert (not (str.in.re v37 (str.to.re "E"))))
(assert (not (str.in.re v98 (str.to.re "C"))))
