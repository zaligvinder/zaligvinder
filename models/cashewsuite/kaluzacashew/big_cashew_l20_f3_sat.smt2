...
(assert (not (str.in.re v33 (str.to.re "D"))))
(assert (not (str.in.re v72 (str.to.re "B"))))
(assert (not (str.in.re v101 (str.to.re "#"))))
(assert (not (str.in.re v88 (str.to.re "B"))))
(assert (not (str.in.re v32 (str.to.re "E"))))
(assert (not (str.in.re v89 (str.to.re "C"))))
