...
(assert (not (str.in_re NEW_DGNode_721 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_720 (str.to_re "%"))))
...
(assert (not (str.in_re NEW_DGNode_757 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_756 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_597 (str.to_re "&"))))
(assert (= M17_10 "&"))
