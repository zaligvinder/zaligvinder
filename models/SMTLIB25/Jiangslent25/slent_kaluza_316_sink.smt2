...
(assert (not (str.in.re NEW_DGNode_256 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_255 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_249 (str.to.re "&"))))
(assert (= M0_10 "&"))
(assert (= T1_10 (str.++ P1_10 T2_10)))
(assert (= P1_10 (str.++ T_16 M1_10)))
(assert (not (str.in.re T_16 (str.to.re "&"))))
(assert (= M1_10 "&"))
