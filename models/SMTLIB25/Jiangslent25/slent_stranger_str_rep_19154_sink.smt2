...
(assert (= b_x_40 (and (= x_40 (str.++ literal_26 sigmaStar_264) ) b_literal_26 b_sigmaStar_264) ))
(assert (= b_x_41 (and (= x_41 (str.++ x_28 literal_31) ) b_x_28 b_literal_31) ))
(assert (= b_x_42 (and (= x_42 (str.++ literal_29 sigmaStar_067) ) b_literal_29 b_sigmaStar_067) ))
...
(assert (> 30 (+ (str.len x_88) (str.len sink)) ) )
(check-sat)
(exit)
