...
(assert (= b_sigmaStar_safe_57 (str.in.re sigmaStar_safe_57 (re.* (re.union (re.range "0" "9") (re.union (re.range "a" "z") (re.range "A" "Z")))))))
(assert (= b_sigmaStar_safe_58 (str.in.re sigmaStar_safe_58 (re.* (re.union (re.range "0" "9") (re.union (re.range "a" "z") (re.range "A" "Z")))))))
(assert (= b_sigmaStar_safe_59 (str.in.re sigmaStar_safe_59 (re.* (re.union (re.range "0" "9") (re.union (re.range "a" "z") (re.range "A" "Z")))))))
