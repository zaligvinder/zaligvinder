...
(assert (= b_sigmaStar_safe_62 (str.in.re sigmaStar_safe_62 (re.* (re.union (re.range "0" "9") (re.union (re.range "a" "z") (re.range "A" "Z")))))))
(assert (and b_literal_26 (= literal_26 "\x27\x29")))
(assert (and b_literal_27 (= literal_27 "\x27")))
(assert (and b_literal_29 (= literal_29 "\x63\x6f\x6d\x6d\x65\x6e\x74\x5f\x6e\x61\x6d\x65\x3d\x27")))
(assert (and b_literal_31 (= literal_31 "\x73\x68\x6f\x75\x74\x5f\x6e\x61\x6d\x65\x3d\x27")))
(assert (and b_literal_38 (= literal_38 "\x28\x73\x68\x6f\x75\x74\x5f\x69\x64\x29")))
(assert (and b_literal_37 (= literal_37 "\x28\x2a\x29")))
(assert (and b_literal_36 (= literal_36 "\x28\x63\x6f\x6d\x6d\x65\x6e\x74\x5f\x69\x64\x29")))
...
(assert (and b_literal_48 (= literal_48 "\x53\x45\x4c\x45\x43\x54\x20\x43\x6f\x75\x6e\x74")))
(assert (and b_literal_49 (= literal_49 "\x20\x41\x4e\x44\x20\x61\x64\x6d\x69\x6e\x5f\x6c\x69\x6e\x6b\x21\x3d\x27\x72\x65\x73\x65\x72\x76\x65\x64\x27\x20\x41\x4e\x44\x20\x61\x64\x6d\x69\x6e\x5f\x70\x61\x67\x65\x3d\x27\x34\x27")))
(assert (and b_literal_50 (= literal_50 "\x20\x41\x4e\x44\x20\x61\x64\x6d\x69\x6e\x5f\x6c\x69\x6e\x6b\x21\x3d\x27\x72\x65\x73\x65\x72\x76\x65\x64\x27\x20\x41\x4e\x44\x20\x61\x64\x6d\x69\x6e\x5f\x70\x61\x67\x65\x3d\x27\x32\x27")))
(assert (and b_literal_51 (= literal_51 "\x20\x41\x4e\x44\x20\x61\x64\x6d\x69\x6e\x5f\x6c\x69\x6e\x6b\x21\x3d\x27\x72\x65\x73\x65\x72\x76\x65\x64\x27\x20\x41\x4e\x44\x20\x61\x64\x6d\x69\x6e\x5f\x70\x61\x67\x65\x3d\x27\x31\x27")))
...
(assert (and b_literal_54 (= literal_54 "\x27")))
(assert (and b_literal_63 (= literal_63 "\x20\x46\x52\x4f\x4d\x20")))
(assert (and b_literal_71 (= literal_71 "\x20\x57\x48\x45\x52\x45\x20")))
(assert (and b_literal_79 (= literal_79 "\x73\x68\x6f\x75\x74\x62\x6f\x78")))
(assert (and b_literal_78 (= literal_78 "\x61\x64\x6d\x69\x6e")))
(assert (and b_literal_77 (= literal_77 "\x63\x6f\x6d\x6d\x65\x6e\x74\x73")))
(assert (and b_literal_76 (= literal_76 "\x62\x6c\x61\x63\x6b\x6c\x69\x73\x74")))
(assert (and b_literal_75 (= literal_75 "\x61\x64\x6d\x69\x6e")))
(assert (and b_literal_74 (= literal_74 "\x61\x64\x6d\x69\x6e")))
(assert (and b_literal_73 (= literal_73 "\x61\x64\x6d\x69\x6e")))
...
(assert (< 10 (+ (str.len x_87) (str.len sink)) ) )
(check-sat)
(exit)
