...
(declare-fun sigmaStar_466 () String)
(declare-fun b_sigmaStar_466 () Bool)
...
(assert (= b_x_52 (or (and (= x_52 sigmaStar_264) b_sigmaStar_264) (and (= x_52 sigmaStar_n0) b_sigmaStar_n0) ) ))
(assert (= b_x_53 (and (= x_53 (str.++ literal_39 x_46) ) b_literal_39 b_x_46) ))
(assert (= b_x_55 (or (and (= x_55 sigmaStar_466) b_sigmaStar_466) (and (= x_55 sigmaStar_n1) b_sigmaStar_n1) ) ))
(assert (= b_x_56 (or (and (= x_56 sigmaStar_367) b_sigmaStar_367) (and (= x_56 sigmaStar_n2) b_sigmaStar_n2) ) ))
(assert (= b_x_57 (or (and (= x_57 sigmaStar_068) b_sigmaStar_068) (and (= x_57 sigmaStar_n3) b_sigmaStar_n3) ) ))
