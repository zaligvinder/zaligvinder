...
(declare-fun sigmaStar_464 () String)
(declare-fun b_sigmaStar_464 () Bool)
(declare-fun sigmaStar_165 () String)
(declare-fun b_sigmaStar_165 () Bool)
...
(assert (= b_x_46 (or (and (= x_46 sigmaStar_n0) b_sigmaStar_n0) (and (= x_46 sigmaStar_464) b_sigmaStar_464) ) ))
(assert (= b_x_47 (or (and (= x_47 sigmaStar_n1) b_sigmaStar_n1) (and (= x_47 sigmaStar_165) b_sigmaStar_165) ) ))
(assert (= b_x_48 (and (= x_48 (str.++ literal_36 x_42) ) b_literal_36 b_x_42) ))
(assert (= b_x_50 (or (and (= x_50 sigmaStar_n2) b_sigmaStar_n2) (and (= x_50 sigmaStar_067) b_sigmaStar_067) ) ))
...
(assert (= 10 (+ (str.len x_77) (str.len sink)) ) )
(check-sat)
(exit)
