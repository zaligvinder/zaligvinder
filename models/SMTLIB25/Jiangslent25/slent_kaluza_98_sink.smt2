...
(assert (not (str.in.re NEW_DGNode_1551 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_1550 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_1675 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_1738 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_1801 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_1864 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_1927 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_1990 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_1481 (str.to.re "&"))))
