...
(declare-fun sigmaStar_154 () String)
(declare-fun b_sigmaStar_154 () Bool)
...
(assert (= b_x_14 (or (and (= x_14 sigmaStar_154) b_sigmaStar_154) (and (= x_14 x_10) b_x_10) ) ))
...
(assert (= b_x_37 (and (= x_37 (str.++ literal_25 sigmaStar_064) ) b_literal_25 b_sigmaStar_064) ))
...
(assert (= 40 (+ (str.len x_78) (str.len sink)) ) )
(check-sat)
(exit)
