...
(assert (not (str.in.re NEW_DGNode_1160 (str.to.re ""))))
(assert (not (str.in.re NEW_DGNode_1159 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_1162 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_985 (str.to.re "&"))))
