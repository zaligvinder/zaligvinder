...
(assert (not (str.in.re NEW_DGNode_278 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_277 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_271 (str.to.re "&"))))
(assert (= M0_10 "&"))
...
(assert (not (str.in.re NEW_DGNode_284 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_283 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_268 (str.to.re "&"))))
(assert (= M1_10 "&"))
(assert (= T2_10 (str.++ P2_10 T3_10)))
(assert (= P2_10 (str.++ T_23 M2_10)))
(assert (not (str.in.re T_23 (str.to.re "&"))))
(assert (= M2_10 "&"))
