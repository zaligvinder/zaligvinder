...
(assert (and b_literal_58 (= literal_58 "\x62\x6c\x61\x63\x6b\x6c\x69\x73\x74")))
...
(assert (= b_x_45 (and (= x_45 (str.++ literal_27 x_34) ) b_literal_27 b_x_34) ))
(assert (= b_x_46 (and (= x_46 (str.++ x_28 literal_40) ) b_x_28 b_literal_40) ))
