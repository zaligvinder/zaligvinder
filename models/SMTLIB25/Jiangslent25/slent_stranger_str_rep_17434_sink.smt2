...
(declare-fun sigmaStar_253 () String)
(declare-fun b_sigmaStar_253 () Bool)
...
(assert (= b_x_14 (and (= x_14 (str.++ literal_11 sigmaStar_253) ) b_literal_11 b_sigmaStar_253) ))
(assert (= b_x_18 (and (= x_18 (str.++ literal_12 sigmaStar_855) ) b_literal_12 b_sigmaStar_855) ))
(assert (= b_x_19 (or (and (= x_19 literal_15) b_literal_15) (and (= x_19 sigmaStar_157) b_sigmaStar_157) ) ))
...
(assert (= b_x_46 (and (= x_46 (str.++ x_35 sigmaStar_069) ) b_x_35 b_sigmaStar_069) ))
...
(assert (= 50 (+ (str.len x_86) (str.len sink)) ) )
(check-sat)
(exit)
