...
(declare-fun sigmaStar_568 () String)
(declare-fun b_sigmaStar_568 () Bool)
...
(assert (= b_x_46 (or (and (= x_46 sigmaStar_462) b_sigmaStar_462) (and (= x_46 x_43) b_x_43) ) ))
...
(assert (= b_x_55 (or (and (= x_55 sigmaStar_166) b_sigmaStar_166) (and (= x_55 sigmaStar_n1) b_sigmaStar_n1) ) ))
(assert (= b_x_56 (or (and (= x_56 sigmaStar_367) b_sigmaStar_367) (and (= x_56 sigmaStar_n2) b_sigmaStar_n2) ) ))
(assert (= b_x_57 (or (and (= x_57 sigmaStar_568) b_sigmaStar_568) (and (= x_57 sigmaStar_n3) b_sigmaStar_n3) ) ))
