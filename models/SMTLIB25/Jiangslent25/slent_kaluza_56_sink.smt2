...
(declare-fun NEW_DGNode_316 () String)
(declare-fun NEW_DGNode_388 () String)
(declare-fun NEW_DGNode_389 () String)
(declare-fun NEW_DGNode_391 () String)
(declare-fun NEW_DGNode_392 () String)
(declare-fun NEW_DGNode_394 () String)
(declare-fun NEW_DGNode_395 () String)
(declare-fun NEW_DGNode_397 () String)
(declare-fun NEW_DGNode_398 () String)
(declare-fun NEW_DGNode_403 () String)
(declare-fun NEW_DGNode_404 () String)
(declare-fun NEW_DGNode_409 () String)
(declare-fun NEW_DGNode_410 () String)
(declare-fun NEW_DGNode_415 () String)
...
(assert (= T_f NEW_DGNode_398))
(assert (= NEW_DGNode_398 NEW_DGNode_397))
(assert (= NEW_DGNode_398 NEW_DGNode_249))
...
(assert (= PCTEMP_LHS_9 NEW_DGNode_404))
(assert (= NEW_DGNode_404 NEW_DGNode_403))
(assert (not (str.in_re NEW_DGNode_404 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_403 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_397 (str.to_re "&"))))
(assert (= M0_10 "&"))
(assert (= T1_10 (str.++ P1_10 T2_10)))
(assert (= P1_10 (str.++ T_1c M1_10)))
(assert (= T_1c NEW_DGNode_395))
(assert (= NEW_DGNode_395 NEW_DGNode_394))
(assert (= NEW_DGNode_395 NEW_DGNode_271))
...
(assert (= PCTEMP_LHS_14 NEW_DGNode_410))
(assert (= NEW_DGNode_410 NEW_DGNode_409))
(assert (not (str.in_re NEW_DGNode_410 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_409 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_394 (str.to_re "&"))))
(assert (= M1_10 "&"))
(assert (= T2_10 (str.++ P2_10 T3_10)))
(assert (= P2_10 (str.++ T_29 M2_10)))
(assert (= T_29 NEW_DGNode_392))
(assert (= NEW_DGNode_392 NEW_DGNode_391))
(assert (= NEW_DGNode_392 NEW_DGNode_293))
...
(assert (= PCTEMP_LHS_19 NEW_DGNode_416))
(assert (= NEW_DGNode_416 NEW_DGNode_415))
(assert (not (str.in_re NEW_DGNode_416 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_415 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_391 (str.to_re "&"))))
(assert (= M2_10 "&"))
(assert (= T3_10 (str.++ P3_10 T4_10)))
(assert (= P3_10 (str.++ T_36 M3_10)))
(assert (= T_36 NEW_DGNode_389))
(assert (= NEW_DGNode_389 NEW_DGNode_388))
(assert (= NEW_DGNode_389 NEW_DGNode_315))
(assert (= NEW_DGNode_315 NEW_DGNode_316))
(assert (= NEW_DGNode_315 (str.++ T1_78 T2_78)))
(assert (= T2_78 (str.++ PCTEMP_LHS_21 T3_78)))
(assert (= NEW_DGNode_316 (str.++ T1_82 T2_82)))
...
(assert (= I0_44 (str.len PCTEMP_LHS_14))) ; len 10
...
(assert (= I0_63 (str.len PCTEMP_LHS_19))) ; len 15
