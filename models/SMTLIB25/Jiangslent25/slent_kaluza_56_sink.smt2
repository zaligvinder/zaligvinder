...
(assert (not (str.in.re NEW_DGNode_404 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_403 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_397 (str.to.re "&"))))
(assert (= M0_10 "&"))
...
(assert (not (str.in.re NEW_DGNode_410 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_409 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_394 (str.to.re "&"))))
(assert (= M1_10 "&"))
...
(assert (not (str.in.re NEW_DGNode_416 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_415 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_391 (str.to.re "&"))))
(assert (= M2_10 "&"))
...
(assert (not (str.in.re NEW_DGNode_422 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_421 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_388 (str.to.re "&"))))
(assert (= M3_10 "&"))
