...
(assert (not (str.in.re NEW_DGNode_300 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_299 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_293 (str.to.re "&"))))
(assert (= M0_10 "&"))
...
(assert (not (str.in.re NEW_DGNode_306 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_305 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_290 (str.to.re "&"))))
(assert (= M1_10 "&"))
...
(assert (not (str.in.re NEW_DGNode_287 (str.to.re "&"))))
(assert (= M2_10 "&"))
(assert (= T3_10 (str.++ P3_10 T4_10)))
(assert (= P3_10 (str.++ T_30 M3_10)))
(assert (not (str.in.re T_30 (str.to.re "&"))))
(assert (= M3_10 "&"))
