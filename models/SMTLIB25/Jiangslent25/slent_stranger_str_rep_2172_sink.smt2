...
(declare-fun sigmaStar_266 () String)
(declare-fun b_sigmaStar_266 () Bool)
...
(assert (= b_x_46 (or (and (= x_46 sigmaStar_362) b_sigmaStar_362) (and (= x_46 x_43) b_x_43) ) ))
...
(assert (= b_x_55 (or (and (= x_55 sigmaStar_266) b_sigmaStar_266) (and (= x_55 sigmaStar_n1) b_sigmaStar_n1) ) ))
(assert (= b_x_56 (or (and (= x_56 sigmaStar_067) b_sigmaStar_067) (and (= x_56 sigmaStar_n2) b_sigmaStar_n2) ) ))
