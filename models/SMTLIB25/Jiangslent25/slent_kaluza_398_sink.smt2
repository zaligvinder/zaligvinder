...
(declare-fun NEW_DGNode_58 () String)
...
(assert (= var_0xINPUT_14469 NEW_DGNode_61))
(assert (= NEW_DGNode_61 NEW_DGNode_62))
(assert (= NEW_DGNode_61 NEW_DGNode_58))
(assert (= NEW_DGNode_58 NEW_DGNode_59))
(assert (= NEW_DGNode_58 ""))
(assert (= NEW_DGNode_59 NEW_DGNode_39))
...
(assert (= I2_44 I1_44))
(assert (<= T_20 I1_44))
(assert (= T_20 (str.len var_0xINPUT_14469))) ; len 0
(assert (= I1_44 (str.len var_0xINPUT_14469))) ; len 0
(assert T_1)
(assert T_2)
(assert (= T_2 (not T_1)))
(assert T_3)
