...
(declare-fun sigmaStar_162 () String)
(declare-fun b_sigmaStar_162 () Bool)
...
(declare-fun sigmaStar_567 () String)
(declare-fun b_sigmaStar_567 () Bool)
(declare-fun sigmaStar_268 () String)
(declare-fun b_sigmaStar_268 () Bool)
...
(assert (and b_literal_37 (= literal_37 "\x2f\x2f")))
(assert (and b_literal_39 (= literal_39 "\x20\x2b\x2b\x20\x2d\x65\x20\x20\x5c\x22")))
(assert (and b_literal_45 (= literal_45 "\x2f\x2f\x6d\x69\x6d\x65\x74\x65\x78\x20\x2d\x65\x20")))
(assert (and b_literal_48 (= literal_48 "\x5c\x22\x2f\x2f\x6d\x69\x6d\x65\x74\x65\x78\x2e\x66\x72\x65\x65\x62\x73\x64\x5c\x22\x20\x2d\x65\x20\x5c\x22")))
(assert (and b_literal_49 (= literal_49 "\x5c\x22\x2f\x2f\x6d\x69\x6d\x65\x74\x65\x78\x2e\x64\x61\x72\x77\x69\x6e\x5c\x22\x20\x2d\x65\x20\x5c\x22")))
(assert (and b_literal_51 (= literal_51 "\x5c\x22\x2f\x2f\x6d\x69\x6d\x65\x74\x65\x78\x2e\x6c\x69\x6e\x75\x78\x5c\x22\x20\x2d\x65\x20\x5c\x22")))
(assert (and b_literal_59 (= literal_59 "\x5c\x22\x20\x2d\x2d\x20")))
(assert (and b_literal_63 (= literal_63 "\x20\x2d\x2d\x20")))
(assert (and b_literal_54 (= literal_54 "\x2f\x2f\x6d\x69\x6d\x65\x74\x65\x78\x2e\x65\x78\x65")))
(assert (and b_literal_67 (= literal_67 "\x5c\x22\x20")))
(assert (and b_literal_68 (= literal_68 "\x5c\x22\x20\x2d\x2d\x20")))
(assert (and b_literal_70 (= literal_70 "\x5c\x22\x20\x2d\x2d\x20")))
(assert (and b_literal_83 (= literal_83 "")))
(assert (and b_literal_84 (= literal_84 "\x54\x68\x65\x20\x73\x68\x65\x6c\x6c\x20\x63\x6f\x6d\x6d\x61\x6e\x64\x3c\x62\x72\x20\x2f\x3e")))
(assert (and b_literal_91 (= literal_91 "\x3c\x62\x72\x20\x2f\x3e\x72\x65\x74\x75\x72\x6e\x65\x64\x20\x73\x74\x61\x74\x75\x73\x20\x3d\x20")))
(assert (and b_literal_92 (= literal_92 "")))
(assert (and b_literal_95 (= literal_95 "\x3c\x62\x72\x20\x2f\x3e\x5c\x6e")))
...
(assert (= b_x_46 (or (and (= x_46 sigmaStar_162) b_sigmaStar_162) (and (= x_46 x_43) b_x_43) ) ))
(assert (= b_x_52 (or (and (= x_52 sigmaStar_364) b_sigmaStar_364) (and (= x_52 sigmaStar_n0) b_sigmaStar_n0) ) ))
...
(assert (= b_x_56 (or (and (= x_56 sigmaStar_567) b_sigmaStar_567) (and (= x_56 sigmaStar_n2) b_sigmaStar_n2) ) ))
(assert (= b_x_57 (or (and (= x_57 sigmaStar_268) b_sigmaStar_268) (and (= x_57 sigmaStar_n3) b_sigmaStar_n3) ) ))
...
(assert (> 20 (+ (str.len x_89) (str.len sink)) ) )
(check-sat)
(exit)
