...
(assert (not (str.in_re NEW_DGNode_320 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_319 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_313 (str.to_re "&"))))
(assert (= M0_10 "&"))
...
(assert (not (str.in_re NEW_DGNode_326 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_325 (str.to_re "%"))))
...
(assert (not (str.in_re NEW_DGNode_338 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_337 (str.to_re "%"))))
