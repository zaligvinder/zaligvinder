...
(declare-fun NEW_DGNode_313 () String)
(declare-fun NEW_DGNode_314 () String)
(declare-fun NEW_DGNode_319 () String)
(declare-fun NEW_DGNode_320 () String)
(declare-fun NEW_DGNode_325 () String)
(declare-fun NEW_DGNode_326 () String)
...
(assert (= T_f NEW_DGNode_314))
(assert (= NEW_DGNode_314 NEW_DGNode_313))
(assert (= NEW_DGNode_314 NEW_DGNode_186))
...
(assert (= PCTEMP_LHS_9 NEW_DGNode_320))
(assert (= NEW_DGNode_320 NEW_DGNode_319))
(assert (not (str.in.re NEW_DGNode_320 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_319 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_313 (str.to.re "&"))))
(assert (= M0_10 "&"))
(assert (= T1_10 (str.++ P1_10 T2_10)))
(assert (= P1_10 (str.++ T_1c M1_10)))
(assert (= T_1c NEW_DGNode_311))
(assert (= NEW_DGNode_311 NEW_DGNode_310))
(assert (= NEW_DGNode_311 NEW_DGNode_208))
...
(assert (= PCTEMP_LHS_14 NEW_DGNode_326))
(assert (= NEW_DGNode_326 NEW_DGNode_325))
(assert (not (str.in.re NEW_DGNode_326 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_325 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_310 (str.to.re "&"))))
(assert (= M1_10 "&"))
...
(assert (not (str.in.re NEW_DGNode_332 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_331 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_307 (str.to.re "&"))))
(assert (= M2_10 "&"))
(assert (= T3_10 (str.++ P3_10 T4_10)))
(assert (= P3_10 (str.++ T_36 M3_10)))
(assert (= T_36 NEW_DGNode_305))
(assert (= NEW_DGNode_305 NEW_DGNode_304))
(assert (= NEW_DGNode_305 NEW_DGNode_252))
...
(assert (= PCTEMP_LHS_24 NEW_DGNode_338))
(assert (= NEW_DGNode_338 NEW_DGNode_337))
(assert (not (str.in.re NEW_DGNode_338 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_337 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_304 (str.to.re "&"))))
(assert (= M3_10 "&"))
