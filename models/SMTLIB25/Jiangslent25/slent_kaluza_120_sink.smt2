...
(assert (not (str.in.re NEW_DGNode_384 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_383 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_377 (str.to.re "&"))))
(assert (= M0_10 "&"))
...
(assert (not (str.in.re NEW_DGNode_390 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_389 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_374 (str.to.re "&"))))
(assert (= M1_10 "&"))
...
(assert (not (str.in.re NEW_DGNode_396 (str.to.re "+"))))
(assert (not (str.in.re NEW_DGNode_395 (str.to.re "%"))))
(assert (not (str.in.re NEW_DGNode_371 (str.to.re "&"))))
(assert (= M2_10 "&"))
