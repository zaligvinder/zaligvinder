...
(declare-fun NEW_DGNode_375 () String)
(declare-fun NEW_DGNode_377 () String)
(declare-fun NEW_DGNode_378 () String)
(declare-fun NEW_DGNode_383 () String)
...
(assert (= T_f NEW_DGNode_378))
(assert (= NEW_DGNode_378 NEW_DGNode_377))
(assert (= NEW_DGNode_378 NEW_DGNode_249))
...
(assert (= PCTEMP_LHS_9 NEW_DGNode_384))
(assert (= NEW_DGNode_384 NEW_DGNode_383))
(assert (not (str.in_re NEW_DGNode_384 (str.to_re "+"))))
(assert (not (str.in_re NEW_DGNode_383 (str.to_re "%"))))
(assert (not (str.in_re NEW_DGNode_377 (str.to_re "&"))))
(assert (= M0_10 "&"))
(assert (= T1_10 (str.++ P1_10 T2_10)))
(assert (= P1_10 (str.++ T_1c M1_10)))
(assert (= T_1c NEW_DGNode_375))
(assert (= NEW_DGNode_375 NEW_DGNode_374))
(assert (= NEW_DGNode_375 NEW_DGNode_271))
...
(assert (not (str.in_re NEW_DGNode_374 (str.to_re "&"))))
(assert (= M1_10 "&"))
