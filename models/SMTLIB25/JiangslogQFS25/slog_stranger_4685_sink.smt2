...
(assert (= literal_1 "\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{5c}\u{6e}\u{3c}\u{2f}\u{74}\u{72}\u{3e}\u{5c}\u{6e}\u{3c}\u{74}\u{72}\u{3e}\u{5c}\u{6e}\u{3c}\u{74}\u{64}\u{20}\u{77}\u{69}\u{64}\u{74}\u{68}\u{3d}\u{27}\u{31}\u{35}\u{30}\u{27}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{74}\u{62}\u{6c}\u{31}\u{27}\u{20}\u{73}\u{74}\u{79}\u{6c}\u{65}\u{3d}\u{27}\u{76}\u{65}\u{72}\u{74}\u{69}\u{63}\u{61}\u{6c}\u{2d}\u{61}\u{6c}\u{69}\u{67}\u{6e}\u{3a}\u{74}\u{6f}\u{70}\u{27}\u{3e}"))
(assert (= x_2 (str.++ literal_1 sigmaStar_0)))
(assert (= literal_3 "\u{3c}\u{62}\u{72}\u{3e}\u{5c}\u{6e}"))
