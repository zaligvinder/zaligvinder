...
(assert (= literal_7 "\u{75}\u{73}\u{65}\u{72}\u{73}\u{20}\u{57}\u{48}\u{45}\u{52}\u{45}\u{20}\u{75}\u{73}\u{65}\u{72}\u{5f}\u{69}\u{64}\u{3d}\u{27}"))
(assert (= x_8 (str.++ x_6 literal_7)))
(assert (= x_9 (str.++ x_8 sigmaStar_1)))
(assert (= literal_10 "\u{27}"))
(assert (= x_11 (str.++ x_9 literal_10)))
(assert (= literal_12 "\u{3c}\u{73}\u{70}\u{61}\u{6e}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{61}\u{6c}\u{74}\u{27}\u{3e}"))
(assert (= x_13 (str.++ literal_12 sigmaStar_3)))
(assert (= literal_14 "\u{3c}\u{2f}\u{73}\u{70}\u{61}\u{6e}\u{3e}\u{20}"))
