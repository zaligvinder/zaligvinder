...
(assert (= literal_5 "\u{3c}\u{64}\u{69}\u{76}\u{20}\u{61}\u{6c}\u{69}\u{67}\u{6e}\u{3d}\u{27}\u{63}\u{65}\u{6e}\u{74}\u{65}\u{72}\u{27}\u{3e}"))
(assert (= literal_2 ""))
(assert (or (= x_4 literal_2) (= x_4 sigmaStar_1) (= x_4 sigmaStar_0)))
(assert (= x_6 (str.++ literal_5 x_4)))
(assert (= literal_7 "\u{3c}\u{2f}\u{64}\u{69}\u{76}\u{3e}\u{5c}\u{6e}"))
