...
(assert (= literal_8 "\u{5b}\u{3c}\u{61}\u{20}\u{68}\u{72}\u{65}\u{66}\u{3d}\u{27}\u{6d}\u{65}\u{73}\u{73}\u{61}\u{67}\u{65}\u{73}\u{2e}\u{70}\u{68}\u{70}\u{3f}\u{6d}\u{73}\u{67}\u{5f}\u{73}\u{65}\u{6e}\u{64}\u{3d}"))
(assert (= epsilon ""))
(assert (or (= x_7 epsilon) (= x_7 sigmaStar_0)))
(assert (= x_9 (str.++ literal_8 x_7)))
(assert (= literal_10 "\u{27}\u{20}\u{74}\u{69}\u{74}\u{6c}\u{65}\u{3d}\u{27}"))
(assert (= x_11 (str.++ x_9 literal_10)))
(assert (= x_12 (str.++ x_11 sigmaStar_1)))
(assert (= literal_13 "\u{27}\u{3e}"))
(assert (= x_14 (str.++ x_12 literal_13)))
(assert (= x_15 (str.++ x_14 sigmaStar_2)))
(assert (= literal_16 "\u{3c}\u{2f}\u{61}\u{3e}\u{5d}\u{5c}\u{6e}"))
