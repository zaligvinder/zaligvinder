...
(assert (= literal_11 "\u{3c}\u{69}\u{6d}\u{67}\u{20}\u{73}\u{72}\u{63}\u{3d}\u{5c}\u{22}\u{2f}\u{66}\u{2f}\u{69}\u{63}\u{6f}\u{6e}\u{5c}\u{22}\u{20}\u{20}\u{68}\u{65}\u{69}\u{67}\u{68}\u{74}\u{3d}\u{5c}\u{22}\u{31}\u{36}\u{5c}\u{22}\u{20}\u{77}\u{69}\u{64}\u{74}\u{68}\u{3d}\u{5c}\u{22}\u{31}\u{36}\u{5c}\u{22}\u{20}\u{61}\u{6c}\u{74}\u{3d}\u{5c}\u{22}\u{5c}\u{22}\u{20}\u{2f}\u{3e}\u{20}"))
(assert (= epsilon ""))
(assert (= literal_2 ""))
(assert (or (= x_4 epsilon) (= x_4 literal_2)))
(assert (= x_12 (str.++ literal_11 x_4)))
(assert (= literal_13 "\u{3c}\u{62}\u{72}\u{20}\u{2f}\u{3e}"))
