...
(assert (= x_17 (str.replace sigmaStar_1 "\u{2f}\u{5c}\u{3c}\u{53}\u{43}\u{52}\u{49}\u{50}\u{54}\u{28}\u{2e}\u{2a}\u{3f}\u{29}\u{2f}" "\u{42}\u{4c}\u{4f}\u{43}\u{4b}\u{45}\u{44}")))
...
(assert (= x_37 (str.replace sigmaStar_2 "\u{2f}\u{5c}\u{3c}\u{53}\u{43}\u{52}\u{49}\u{50}\u{54}\u{28}\u{2e}\u{2a}\u{3f}\u{29}\u{2f}" "\u{42}\u{4c}\u{4f}\u{43}\u{4b}\u{45}\u{44}")))
