...
(assert (= literal_12 "\u{5c}\u{22}\u{20}\u{6e}\u{61}\u{6d}\u{65}\u{3d}\u{5c}\u{22}\u{71}\u{75}\u{69}\u{63}\u{6b}\u{74}\u{69}\u{6d}\u{65}\u{5c}\u{22}\u{20}\u{74}\u{79}\u{70}\u{65}\u{3d}\u{5c}\u{22}"))
