...
(assert (= literal_12 "\u{3c}\u{73}\u{74}\u{72}\u{6f}\u{6e}\u{67}\u{3e}\u{20}"))
(assert (= epsilon ""))
(assert (= literal_8 "\u{75}\u{73}\u{65}\u{72}"))
(assert (or (= x_13 epsilon) (= x_13 literal_8)))
(assert (= x_14 (str.++ literal_12 x_13)))
(assert (= literal_15 "\u{3c}\u{2f}\u{73}\u{74}\u{72}\u{6f}\u{6e}\u{67}\u{3e}"))
