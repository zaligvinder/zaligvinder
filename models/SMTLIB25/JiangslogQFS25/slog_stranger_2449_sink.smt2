...
(assert (= literal_16 "\u{2f}\u{74}\u{2f}\u{75}\u{73}\u{65}\u{72}\u{2e}\u{67}\u{69}\u{66}\u{5c}\u{22}\u{20}\u{68}\u{65}\u{69}\u{67}\u{68}\u{74}\u{3d}\u{5c}\u{22}\u{31}\u{31}\u{5c}\u{22}\u{20}\u{77}\u{69}\u{64}\u{74}\u{68}\u{3d}\u{5c}\u{22}\u{31}\u{31}\u{5c}\u{22}\u{20}\u{62}\u{6f}\u{72}\u{64}\u{65}\u{72}\u{3d}\u{5c}\u{22}\u{30}\u{5c}\u{22}\u{3e}\u{3c}\u{2f}\u{61}\u{3e}\u{20}"))
(assert (= x_17 (str.++ x_13 literal_16)))
(assert (= literal_18 "\u{3c}\u{61}\u{20}\u{74}\u{69}\u{74}\u{6c}\u{65}\u{3d}\u{22}\u{61}\u{73}\u{73}\u{69}\u{67}\u{6e}\u{74}\u{65}\u{61}\u{63}\u{68}\u{65}\u{72}\u{73}\u{5c}\u{22}\u{20}\u{68}\u{72}\u{65}\u{66}\u{3d}\u{5c}\u{22}\u{2f}\u{63}\u{6f}\u{75}\u{72}\u{73}\u{65}\u{2f}\u{74}\u{65}\u{61}\u{63}\u{68}\u{65}\u{72}\u{2e}\u{70}\u{68}\u{70}\u{3f}\u{69}\u{64}\u{3d}\u{5c}\u{22}\u{3e}\u{3c}\u{69}\u{6d}\u{67}"))
