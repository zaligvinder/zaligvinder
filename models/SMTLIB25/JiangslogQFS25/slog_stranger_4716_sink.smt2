...
(assert (= literal_2 "\u{3c}\u{74}\u{72}\u{3e}\u{d}\u{a}\u{3c}\u{74}\u{64}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{74}\u{62}\u{6c}\u{27}\u{3e}"))
