...
(assert (= literal_6 "\u{2f}\u{63}\u{61}\u{6c}\u{65}\u{6e}\u{64}\u{61}\u{72}\u{2f}\u{65}\u{76}\u{65}\u{6e}\u{74}\u{2e}\u{70}\u{68}\u{70}\u{3f}\u{61}\u{63}\u{74}\u{69}\u{6f}\u{6e}\u{3d}\u{64}\u{65}\u{6c}\u{65}\u{74}\u{65}\u{26}\u{61}\u{6d}\u{70}\u{3b}\u{69}\u{64}\u{3d}"))
(assert (= literal_7 "\u{2f}\u{63}\u{6f}\u{75}\u{72}\u{73}\u{65}\u{2f}\u{6d}\u{6f}\u{64}\u{2e}\u{70}\u{68}\u{70}\u{3f}\u{64}\u{65}\u{6c}\u{65}\u{74}\u{65}\u{3d}\u{26}\u{61}\u{6d}\u{70}\u{3b}\u{73}\u{65}\u{73}\u{73}\u{6b}\u{65}\u{79}\u{3d}"))
