...
(assert (= literal_2 "\u{3c}\u{61}\u{20}\u{68}\u{72}\u{65}\u{66}\u{3d}\u{27}"))
(assert (= x_3 (str.++ literal_2 sigmaStar_1)))
(assert (= literal_4 "\u{3f}\u{73}\u{74}\u{65}\u{70}\u{3d}\u{30}\u{26}\u{6c}\u{6f}\u{63}\u{61}\u{6c}\u{65}\u{73}\u{65}\u{74}\u{3d}"))
...
(assert (= literal_11 "\u{3c}\u{2f}\u{61}\u{3e}"))
