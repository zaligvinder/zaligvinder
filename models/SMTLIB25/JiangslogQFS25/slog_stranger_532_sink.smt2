...
(assert (= x_5 (str.replace sigmaStar_0 "\u{2f}\u{2e}\u{28}\u{5c}\u{64}\u{2b}\u{29}\u{2e}\u{2f}" "\u{5f}\u{24}\u{31}\u{2e}")))
(assert (= literal_6 "\u{20}\u{20}\u{20}\u{20}"))
(assert (= x_7 (str.++ literal_6 x_5)))
(assert (= literal_8 "\u{20}\u{3d}\u{20}\u{27}"))
(assert (= x_9 (str.++ x_7 literal_8)))
(assert (= x_10 (str.++ x_9 sigmaStar_0)))
(assert (= literal_11 "\u{27}\u{3b}\u{5c}\u{6e}"))
