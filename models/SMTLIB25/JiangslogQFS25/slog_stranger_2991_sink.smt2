...
(assert (= literal_8 "\u{3c}\u{2f}\u{73}\u{70}\u{61}\u{6e}\u{3e}\u{5c}\u{6e}\u{3c}\u{73}\u{70}\u{61}\u{6e}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{73}\u{6d}\u{61}\u{6c}\u{6c}\u{27}\u{3e}"))
(assert (= x_10 (str.++ literal_8 sigmaStar_0)))
(assert (or (= x_9 sigmaStar_7) (= x_9 sigmaStar_6)))
(assert (= x_11 (str.++ x_10 x_9)))
(assert (= literal_12 "\u{3c}\u{2f}\u{73}\u{70}\u{61}\u{6e}\u{3e}"))
