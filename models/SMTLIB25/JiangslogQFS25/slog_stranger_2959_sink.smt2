...
(assert (= literal_7 "\u{d}\u{a}\u{9}\u{53}\u{45}\u{4c}\u{45}\u{43}\u{54}\u{20}\u{74}\u{66}\u{2e}\u{66}\u{6f}\u{72}\u{75}\u{6d}\u{5f}\u{69}\u{64}\u{2c}\u{20}\u{74}\u{74}\u{2e}\u{74}\u{68}\u{72}\u{65}\u{61}\u{64}\u{5f}\u{69}\u{64}\u{2c}\u{20}\u{74}\u{74}\u{2e}\u{74}\u{68}\u{72}\u{65}\u{61}\u{64}\u{5f}\u{73}\u{75}\u{62}\u{6a}\u{65}\u{63}\u{74}\u{2c}\u{20}\u{43}\u{4f}\u{55}\u{4e}\u{54}\u{28}\u{74}\u{70}\u{2e}\u{70}\u{6f}\u{73}\u{74}\u{5f}\u{69}\u{64}\u{29}\u{20}\u{61}\u{73}\u{20}\u{63}\u{6f}\u{75}\u{6e}\u{74}\u{5f}\u{70}\u{6f}\u{73}\u{74}\u{73}\u{20}\u{d}\u{a}\u{9}\u{46}\u{52}\u{4f}\u{4d}\u{20}"))
(assert (= x_8 (str.++ literal_7 sigmaStar_2)))
(assert (= literal_9 "\u{66}\u{6f}\u{72}\u{75}\u{6d}\u{73}\u{20}\u{74}\u{66}\u{d}\u{a}\u{9}\u{49}\u{4e}\u{4e}\u{45}\u{52}\u{20}\u{4a}\u{4f}\u{49}\u{4e}\u{20}"))
(assert (= x_10 (str.++ x_8 literal_9)))
(assert (= x_12 (str.++ x_10 sigmaStar_1)))
(assert (= literal_13 "\u{74}\u{68}\u{72}\u{65}\u{61}\u{64}\u{73}\u{20}\u{74}\u{74}\u{20}\u{55}\u{53}\u{49}\u{4e}\u{47}\u{28}\u{66}\u{6f}\u{72}\u{75}\u{6d}\u{5f}\u{69}\u{64}\u{29}\u{d}\u{a}\u{9}\u{49}\u{4e}\u{4e}\u{45}\u{52}\u{20}\u{4a}\u{4f}\u{49}\u{4e}\u{20}"))
(assert (= x_15 (str.++ x_12 literal_13)))
(assert (= x_17 (str.++ x_15 sigmaStar_6)))
(assert (= literal_19 "\u{70}\u{6f}\u{73}\u{74}\u{73}\u{20}\u{74}\u{70}\u{20}\u{55}\u{53}\u{49}\u{4e}\u{47}\u{28}\u{74}\u{68}\u{72}\u{65}\u{61}\u{64}\u{5f}\u{69}\u{64}\u{29}\u{d}\u{a}\u{9}\u{57}\u{48}\u{45}\u{52}\u{45}\u{20}"))
...
(assert (= literal_35 "\u{3c}\u{2f}\u{61}\u{3e}\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{d}\u{a}\u{3c}\u{74}\u{64}\u{20}\u{61}\u{6c}\u{69}\u{67}\u{6e}\u{3d}\u{27}\u{72}\u{69}\u{67}\u{68}\u{74}\u{27}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{73}\u{69}\u{64}\u{65}\u{2d}\u{73}\u{6d}\u{61}\u{6c}\u{6c}\u{27}\u{3e}\u{5b}"))
