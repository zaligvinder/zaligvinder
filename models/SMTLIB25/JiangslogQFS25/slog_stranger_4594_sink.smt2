...
(assert (= literal_29 "\u{3c}\u{2f}\u{62}\u{3e}\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{d}\u{a}\u{3c}\u{74}\u{64}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{74}\u{62}\u{6c}\u{31}\u{27}\u{3e}"))
(assert (= x_31 (str.++ x_28 literal_29)))
(assert (or (= x_32 epsilon) (= x_32 sigmaStar_3) (= x_32 sigmaStar_4)))
(assert (= x_33 (str.++ x_31 x_32)))
(assert (= literal_34 "\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{d}\u{a}\u{3c}\u{2f}\u{74}\u{72}\u{3e}\u{d}\u{a}\u{3c}\u{74}\u{72}\u{3e}\u{d}\u{a}\u{3c}\u{74}\u{64}\u{20}\u{61}\u{6c}\u{69}\u{67}\u{6e}\u{3d}\u{27}\u{63}\u{65}\u{6e}\u{74}\u{65}\u{72}\u{27}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{74}\u{62}\u{6c}\u{31}\u{27}\u{3e}\u{5c}\u{6e}"))
