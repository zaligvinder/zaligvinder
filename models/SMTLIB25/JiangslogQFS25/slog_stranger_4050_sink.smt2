...
(assert (= literal_4 "\u{75}\u{73}\u{65}\u{72}\u{73}\u{20}\u{57}\u{48}\u{45}\u{52}\u{45}\u{20}\u{75}\u{73}\u{65}\u{72}\u{5f}\u{69}\u{64}\u{3d}\u{27}"))
...
(assert (= literal_11 "\u{61}\u{76}\u{61}\u{74}\u{61}\u{72}\u{73}\u{2f}"))
