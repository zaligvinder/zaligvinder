...
(assert (= literal_2 "\u{3c}\u{63}\u{65}\u{6e}\u{74}\u{65}\u{72}\u{3e}"))
(assert (= x_3 (str.++ literal_2 sigmaStar_1)))
(assert (= literal_4 "\u{3c}\u{62}\u{72}\u{3e}\u{3c}\u{62}\u{72}\u{3e}"))
(assert (= x_5 (str.++ x_3 literal_4)))
(assert (= x_6 (str.++ x_5 sigmaStar_0)))
(assert (= literal_7 "\u{3c}\u{62}\u{72}\u{3e}\u{3c}\u{62}\u{72}\u{3e}"))
