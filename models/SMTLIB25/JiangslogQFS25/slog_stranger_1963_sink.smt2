...
(assert (= literal_10 "\u{3c}\u{61}\u{20}\u{74}\u{69}\u{74}\u{6c}\u{65}\u{3d}\u{5c}\u{22}\u{70}\u{72}\u{65}\u{76}\u{69}\u{65}\u{77}\u{5c}\u{22}\u{20}\u{68}\u{72}\u{65}\u{66}\u{3d}\u{5c}\u{22}\u{6a}\u{61}\u{76}\u{61}\u{73}\u{63}\u{72}\u{69}\u{70}\u{74}\u{3a}\u{76}\u{6f}\u{69}\u{64}\u{28}\u{29}\u{3b}\u{5c}\u{22}\u{20}\u{6f}\u{6e}\u{43}\u{6c}\u{69}\u{63}\u{6b}\u{3d}\u{5c}\u{22}\u{6f}\u{70}\u{65}\u{6e}\u{70}\u{6f}\u{70}\u{75}\u{70}\u{28}\u{27}\u{2f}\u{71}\u{75}\u{65}\u{73}\u{74}\u{69}\u{6f}\u{6e}\u{2f}\u{70}\u{72}\u{65}\u{76}\u{69}\u{65}\u{77}\u{2e}\u{70}\u{68}\u{70}\u{3f}\u{69}\u{64}\u{3d}\u{26}\u{71}\u{75}\u{69}\u{7a}\u{69}\u{64}\u{3d}"))
(assert (= epsilon ""))
(assert (= literal_7 "\u{30}"))
(assert (or (= x_9 epsilon) (= x_9 literal_7)))
(assert (= x_11 (str.++ literal_10 x_9)))
(assert (= literal_12 "\u{27}\u{2c}\u{27}"))
(assert (= x_13 (str.++ x_11 literal_12)))
(assert (= literal_3 "\u{70}\u{72}\u{65}\u{76}\u{69}\u{65}\u{77}"))
(assert (= x_14 (str.++ x_13 literal_3)))
(assert (= literal_15 "\u{27}\u{2c}\u{27}\u{73}\u{63}\u{72}\u{6f}\u{6c}\u{6c}\u{62}\u{61}\u{72}\u{73}\u{3d}\u{79}\u{65}\u{73}\u{2c}\u{72}\u{65}\u{73}\u{69}\u{7a}\u{61}\u{62}\u{6c}\u{65}\u{3d}\u{79}\u{65}\u{73}\u{2c}\u{77}\u{69}\u{64}\u{74}\u{68}\u{3d}\u{37}\u{30}\u{30}\u{2c}\u{68}\u{65}\u{69}\u{67}\u{68}\u{74}\u{3d}\u{34}\u{38}\u{30}\u{27}\u{2c}\u{20}\u{66}\u{61}\u{6c}\u{73}\u{65}\u{29}\u{5c}\u{22}\u{3e}\u{3c}\u{69}\u{6d}\u{67}\u{d}\u{a}\u{20}\u{20}\u{20}\u{20}\u{20}\u{20}\u{20}\u{20}\u{20}\u{20}\u{20}\u{20}\u{20}\u{20}\u{73}\u{72}\u{63}\u{3d}\u{5c}\u{22}"))
...
(assert (= literal_20 "\u{5c}\u{22}\u{20}\u{2f}\u{3e}\u{3c}\u{2f}\u{61}\u{3e}\u{26}\u{6e}\u{62}\u{73}\u{70}\u{3b}"))
