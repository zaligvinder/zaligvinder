...
(assert (= literal_5 "\x5b\x20\x3c\x61\x20\x68\x72\x65\x66\x3d\x27"))
(assert (= literal_2 "\x68\x74\x74\x70\x3a\x2f\x2f"))
(assert (= literal_3 ""))
...
(assert (= literal_9 "\x27\x20\x74\x69\x74\x6c\x65\x3d\x27"))
(assert (= x_10 (str.++ x_8 literal_9)))
(assert (= x_11 (str.++ x_10 x_4)))
(assert (= x_12 (str.++ x_11 x_7)))
(assert (= literal_13 "\x27\x20\x74\x61\x72\x67\x65\x74\x3d\x27\x5f\x62\x6c\x61\x6e\x6b\x27\x3e"))
(assert (= x_14 (str.++ x_12 literal_13)))
(assert (= x_15 (str.++ x_14 sigmaStar_0)))
(assert (= literal_16 "\x3c\x2f\x61\x3e\x20\x5d\x5c\x6e"))
