...
(assert (= literal_20 "\x42\x79\x74\x65\x73"))
(assert (= x_26 (str.++ sigmaStar_12 literal_20)))
(assert (= literal_25 "\x3c\x62\x3e"))
(assert (= x_27 (str.++ literal_25 sigmaStar_3)))
(assert (= literal_28 "\x3c\x62\x3e"))
(assert (= x_35 (str.++ literal_28 sigmaStar_9)))
(assert (= literal_30 "\x3c\x2f\x62\x3e\x3c\x62\x72\x3e\x5c\x6e"))
(assert (= x_41 (str.++ x_27 literal_30)))
(assert (= literal_31 "\x3c\x62\x3e"))
(assert (= x_42 (str.++ literal_31 sigmaStar_6)))
(assert (= literal_32 "\x3c\x62\x3e"))
(assert (= x_43 (str.++ literal_32 sigmaStar_5)))
(assert (= literal_33 "\x3c\x62\x3e"))
(assert (= x_44 (str.++ literal_33 sigmaStar_7)))
(assert (= literal_34 "\x3c\x62\x3e"))
(assert (= x_45 (str.++ literal_34 sigmaStar_2)))
(assert (= literal_46 "\x3c\x2f\x62\x3e\x3c\x62\x72\x3e\x5c\x6e"))
(assert (= x_51 (str.++ x_35 literal_46)))
(assert (= x_54 (str.++ x_41 sigmaStar_11)))
(assert (= literal_47 "\x3c\x2f\x62\x3e"))
(assert (= x_55 (str.++ x_42 literal_47)))
(assert (= literal_48 "\x3c\x2f\x62\x3e"))
(assert (= x_56 (str.++ x_43 literal_48)))
(assert (= literal_49 "\x3c\x2f\x62\x3e"))
(assert (= x_57 (str.++ x_44 literal_49)))
(assert (= literal_50 "\x3c\x2f\x62\x3e"))
(assert (= x_58 (str.++ x_45 literal_50)))
(assert (= literal_69 "\x3c\x64\x69\x76\x20\x61\x6c\x69\x67\x6e\x3d\x27\x63\x65\x6e\x74\x65\x72\x27\x3e"))
...
(assert (= literal_71 "\x3c\x2f\x64\x69\x76\x3e\x5c\x6e"))
