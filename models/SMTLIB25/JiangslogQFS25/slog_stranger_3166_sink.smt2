...
(assert (= literal_1 "\u{3c}\u{63}\u{65}\u{6e}\u{74}\u{65}\u{72}\u{3e}"))
(assert (= x_2 (str.++ literal_1 sigmaStar_0)))
(assert (= literal_3 "\u{20}\u{3c}\u{69}\u{6e}\u{70}\u{75}\u{74}\u{20}\u{74}\u{79}\u{70}\u{65}\u{3d}\u{27}\u{66}\u{69}\u{6c}\u{65}\u{27}\u{20}\u{6e}\u{61}\u{6d}\u{65}\u{3d}\u{27}\u{75}\u{70}\u{6c}\u{6f}\u{61}\u{64}\u{5f}\u{62}\u{61}\u{63}\u{6b}\u{75}\u{70}\u{5f}\u{66}\u{69}\u{6c}\u{65}\u{27}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{74}\u{65}\u{78}\u{74}\u{62}\u{6f}\u{78}\u{27}\u{3e}\u{3c}\u{62}\u{72}\u{3e}\u{3c}\u{62}\u{72}\u{3e}\u{5c}\u{6e}"))
