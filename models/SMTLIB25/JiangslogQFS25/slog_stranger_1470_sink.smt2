...
(assert (= literal_38 "\u{3c}\u{61}\u{20}\u{74}\u{61}\u{72}\u{67}\u{65}\u{74}\u{3d}\u{22}\u{4c}\u{41}\u{4d}\u{53}\u{20}\u{4c}\u{65}\u{61}\u{72}\u{6e}\u{65}\u{72}\u{22}\u{20}\u{74}\u{69}\u{74}\u{6c}\u{65}\u{3d}\u{22}\u{4c}\u{41}\u{4d}\u{53}\u{20}\u{4c}\u{65}\u{61}\u{72}\u{6e}\u{65}\u{72}\u{22}\u{20}\u{68}\u{72}\u{65}\u{66}\u{3d}\u{22}"))
(assert (= x_39 (str.++ literal_38 x_37)))
(assert (= literal_42 "\u{22}\u{3e}"))
(assert (= x_43 (str.++ x_39 literal_42)))
(assert (= literal_41 "\u{6f}\u{70}\u{65}\u{6e}\u{6c}\u{65}\u{61}\u{72}\u{6e}\u{65}\u{72}"))
