...
(assert (= literal_7 "\u{5c}\u{6e}\u{23}\u{5c}\u{6e}\u{23}\u{20}\u{53}\u{74}\u{72}\u{75}\u{63}\u{74}\u{75}\u{72}\u{65}\u{20}\u{66}\u{6f}\u{72}\u{20}\u{54}\u{61}\u{62}\u{6c}\u{65}\u{20}\u{60}"))
(assert (= x_8 (str.++ literal_7 sigmaStar_0)))
(assert (= literal_9 "\u{60}"))
(assert (= x_10 (str.++ x_8 literal_9)))
(assert (= literal_1 "\u{5c}\u{6e}"))
(assert (= x_11 (str.++ x_10 literal_1)))
(assert (= literal_12 "\u{23}"))
