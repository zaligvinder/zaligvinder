...
(assert (= literal_3 "\u{5f}\u{6c}\u{6f}\u{63}\u{61}\u{6c}"))
(assert (= x_4 (str.++ x_2 literal_3)))
(assert (= literal_5 "\u{3c}\u{64}\u{69}\u{76}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{22}\u{6e}\u{6f}\u{74}\u{69}\u{66}\u{79}\u{70}\u{72}\u{6f}\u{62}\u{6c}\u{65}\u{6d}\u{22}\u{20}\u{61}\u{6c}\u{69}\u{67}\u{6e}\u{3d}\u{22}\u{63}\u{65}\u{6e}\u{74}\u{65}\u{72}\u{22}\u{3e}\u{45}\u{52}\u{52}\u{4f}\u{52}\u{3a}\u{20}\u{43}\u{6f}\u{75}\u{6c}\u{64}\u{20}\u{6e}\u{6f}\u{74}\u{20}\u{63}\u{72}\u{65}\u{61}\u{74}\u{65}\u{20}\u{64}\u{69}\u{72}\u{65}\u{63}\u{74}\u{6f}\u{72}\u{79}\u{20}"))
