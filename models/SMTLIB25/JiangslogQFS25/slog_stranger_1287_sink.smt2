...
(assert (= literal_8 "\u{3c}\u{73}\u{70}\u{61}\u{6e}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{22}\u{66}\u{6f}\u{72}\u{75}\u{6d}\u{74}\u{68}\u{72}\u{65}\u{61}\u{64}\u{20}\u{75}\u{6e}\u{72}\u{65}\u{61}\u{64}\u{22}\u{3e}"))
...
(assert (= literal_7 "\u{3c}\u{73}\u{70}\u{61}\u{6e}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{22}\u{66}\u{6f}\u{72}\u{75}\u{6d}\u{74}\u{68}\u{72}\u{65}\u{61}\u{64}\u{22}\u{3e}"))
