...
(assert (= literal_11 "\u{3c}\u{2f}\u{62}\u{3e}\u{3c}\u{2f}\u{73}\u{70}\u{61}\u{6e}\u{3e}\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{d}\u{a}\u{3c}\u{2f}\u{74}\u{72}\u{3e}\u{5c}\u{6e}"))
