...
(assert (= literal_4 "\u{3c}\u{6f}\u{70}\u{74}\u{69}\u{6f}\u{6e}\u{20}\u{76}\u{61}\u{6c}\u{75}\u{65}\u{3d}\u{27}\u{31}\u{27}"))
(assert (= literal_2 ""))
(assert (= literal_1 "\u{20}\u{73}\u{65}\u{6c}\u{65}\u{63}\u{74}\u{65}\u{64}"))
(assert (or (= x_3 literal_2) (= x_3 literal_1)))
(assert (= x_5 (str.++ literal_4 x_3)))
(assert (= literal_6 "\u{3e}"))
(assert (= x_7 (str.++ x_5 literal_6)))
(assert (= x_8 (str.++ x_7 sigmaStar_0)))
(assert (= literal_9 "\u{3c}\u{2f}\u{6f}\u{70}\u{74}\u{69}\u{6f}\u{6e}\u{3e}\u{5c}\u{6e}"))
