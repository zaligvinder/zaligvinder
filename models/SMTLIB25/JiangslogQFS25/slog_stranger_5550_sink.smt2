...
(assert (= literal_27 "\u{43}\u{41}\u{43}\u{48}\u{45}\u{2f}\u{74}\u{70}\u{6c}\u{5f}"))
...
(assert (= literal_35 "\u{2e}\u{70}\u{68}\u{70}"))
(assert (= x_36 (str.++ x_34 literal_35)))
(assert (= literal_37 ""))
(assert (= x_38 (str.++ literal_37 x_36)))
(assert (str.in_re x_38 (re.++ (re.* re.allchar) (re.++ (str.to_re "\u{2f}\u{65}\u{76}\u{69}\u{6c}") (re.* re.allchar)))))
(check-sat)
(exit)
