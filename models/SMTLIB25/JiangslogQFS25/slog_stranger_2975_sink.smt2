...
(assert (= literal_12 "\u{75}\u{73}\u{65}\u{72}\u{73}\u{d}\u{a}\u{9}\u{4f}\u{4e}\u{20}"))
...
(assert (= literal_18 "\u{75}\u{73}\u{65}\u{72}\u{73}\u{2e}\u{75}\u{73}\u{65}\u{72}\u{5f}\u{69}\u{64}\u{d}\u{a}\u{9}\u{4f}\u{52}\u{44}\u{45}\u{52}\u{20}\u{42}\u{59}\u{20}\u{73}\u{68}\u{6f}\u{75}\u{74}\u{5f}\u{64}\u{61}\u{74}\u{65}\u{73}\u{74}\u{61}\u{6d}\u{70}\u{20}\u{44}\u{45}\u{53}\u{43}\u{20}\u{4c}\u{49}\u{4d}\u{49}\u{54}\u{20}\u{30}\u{2c}"))
