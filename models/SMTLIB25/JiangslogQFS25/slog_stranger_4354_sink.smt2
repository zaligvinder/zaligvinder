...
(assert (= literal_3 "\u{3c}\u{73}\u{70}\u{61}\u{6e}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{61}\u{6c}\u{74}\u{27}\u{3e}"))
(assert (= x_5 (str.++ literal_3 sigmaStar_0)))
(assert (= literal_8 "\u{3c}\u{2f}\u{73}\u{70}\u{61}\u{6e}\u{3e}\u{20}"))
...
(assert (= literal_20 "\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{d}\u{a}\u{3c}\u{74}\u{64}\u{20}\u{61}\u{6c}\u{69}\u{67}\u{6e}\u{3d}\u{27}\u{72}\u{69}\u{67}\u{68}\u{74}\u{27}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{74}\u{62}\u{6c}\u{31}\u{27}\u{3e}\u{5c}\u{6e}"))
