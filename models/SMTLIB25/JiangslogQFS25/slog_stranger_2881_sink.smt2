...
(assert (= literal_1 "\u{70}\u{62}\u{6c}\u{67}\u{75}\u{65}\u{73}\u{74}\u{62}\u{6f}\u{6f}\u{6b}\u{5f}\u{62}\u{61}\u{63}\u{6b}\u{75}\u{70}\u{5f}"))
(assert (= x_2 (str.++ literal_1 sigmaStar_0)))
(assert (= literal_3 "\u{2e}\u{74}\u{78}\u{74}"))
