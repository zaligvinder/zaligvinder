...
(assert (= literal_8 "\u{26}\u{61}\u{6d}\u{70}\u{3b}\u{70}\u{61}\u{67}\u{65}\u{6e}\u{75}\u{6d}\u{3d}\u{33}\u{27}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{73}\u{69}\u{64}\u{65}\u{27}\u{3e}"))
