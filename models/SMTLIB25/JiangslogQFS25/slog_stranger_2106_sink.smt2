...
(assert (= literal_30 "\u{68}\u{69}\u{64}\u{64}\u{65}\u{6e}\u{20}\u{28}\u{3c}\u{61}\u{20}\u{68}\u{72}\u{65}\u{66}\u{3d}\u{22}\u{2f}\u{63}\u{61}\u{6c}\u{65}\u{6e}\u{64}\u{61}\u{72}\u{2f}\u{73}\u{65}\u{74}\u{2e}\u{70}\u{68}\u{70}\u{3f}\u{76}\u{61}\u{72}\u{3d}\u{73}\u{68}\u{6f}\u{77}\u{63}\u{6f}\u{75}\u{72}\u{73}\u{65}\u{73}\u{26}\u{61}\u{6d}\u{70}\u{3b}"))
