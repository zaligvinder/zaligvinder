...
(assert (or (= x_14 sigmaStar_3) (= x_14 x_13)))
(assert (= x_16 (str.++ literal_15 x_14)))
(assert (= literal_17 "\x26\x61\x6d\x70\x3b\x70\x61\x67\x65\x6e\x75\x6d\x3d\x31\x27\x3e"))
(assert (= x_18 (str.++ x_16 literal_17)))
(assert (= x_20 (str.++ x_18 sigmaStar_0)))
(assert (= literal_19 "\x3c\x62\x3e"))
(assert (= x_21 (str.++ literal_19 sigmaStar_2)))
