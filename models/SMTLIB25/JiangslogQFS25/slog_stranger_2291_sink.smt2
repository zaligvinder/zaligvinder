...
(assert (= literal_6 "\u{7c}\u{20}\u{3c}\u{61}\u{20}\u{68}\u{72}\u{65}\u{66}\u{3d}\u{22}\u{2f}\u{62}\u{6c}\u{6f}\u{67}\u{2f}\u{65}\u{64}\u{69}\u{74}\u{2e}\u{70}\u{68}\u{70}\u{3f}\u{61}\u{63}\u{74}\u{3d}\u{64}\u{65}\u{6c}\u{26}\u{61}\u{6d}\u{70}\u{3b}\u{65}\u{64}\u{69}\u{74}\u{69}\u{64}\u{3d}\u{26}\u{61}\u{6d}\u{70}\u{3b}\u{73}\u{65}\u{73}\u{73}\u{6b}\u{65}\u{79}\u{3d}"))
(assert (= x_8 (str.++ literal_6 sigmaStar_1)))
(assert (= literal_9 "\u{22}\u{3e}"))
(assert (= x_10 (str.++ x_8 literal_9)))
(assert (= literal_7 "\u{64}\u{65}\u{6c}\u{65}\u{74}\u{65}"))
