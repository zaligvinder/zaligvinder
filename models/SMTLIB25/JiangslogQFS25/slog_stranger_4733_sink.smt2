...
(assert (= literal_3 "\u{20}\u{76}\u{61}\u{6c}\u{69}\u{67}\u{6e}\u{3d}\u{74}\u{6f}\u{70}\u{27}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{73}\u{69}\u{64}\u{65}\u{2d}\u{62}\u{6f}\u{72}\u{64}\u{65}\u{72}\u{2d}\u{6c}\u{65}\u{66}\u{74}\u{27}\u{3e}\u{5c}\u{6e}"))
