...
(assert (= literal_51 "\u{d}\u{a}\u{d}\u{a}\u{3c}\u{68}\u{74}\u{6d}\u{6c}\u{3e}\u{3c}\u{68}\u{65}\u{61}\u{64}\u{3e}\u{3c}\u{74}\u{69}\u{74}\u{6c}\u{65}\u{3e}\u{50}\u{6c}\u{6f}\u{74}\u{74}\u{69}\u{6e}\u{67}\u{20}"))
(assert (= epsilon ""))
(assert (or (= x_34 epsilon) (= x_34 sigmaStar_19)))
(assert (= x_53 (str.++ literal_51 x_34)))
(assert (= literal_56 "\u{3c}\u{2f}\u{74}\u{69}\u{74}\u{6c}\u{65}\u{3e}\u{d}\u{a}"))
...
(assert (= literal_67 "\u{d}\u{a}\u{d}\u{a}\u{3c}\u{21}\u{2d}\u{2d}\u{20}\u{79}\u{6f}\u{75}\u{72}\u{20}\u{68}\u{65}\u{61}\u{64}\u{20}\u{74}\u{61}\u{67}\u{73}\u{20}\u{68}\u{65}\u{72}\u{65}\u{20}\u{2d}\u{2d}\u{3e}\u{d}\u{a}\u{3c}\u{6c}\u{69}\u{6e}\u{6b}\u{20}\u{72}\u{65}\u{6c}\u{3d}\u{22}\u{53}\u{74}\u{79}\u{6c}\u{65}\u{73}\u{68}\u{65}\u{65}\u{74}\u{22}\u{20}\u{68}\u{72}\u{65}\u{66}\u{3d}\u{22}\u{69}\u{70}\u{2d}\u{61}\u{74}\u{6c}\u{61}\u{73}\u{2e}\u{63}\u{73}\u{73}\u{22}\u{3e}\u{d}\u{a}\u{3c}\u{2f}\u{68}\u{65}\u{61}\u{64}\u{3e}\u{3c}\u{62}\u{6f}\u{64}\u{79}\u{20}\u{62}\u{67}\u{63}\u{6f}\u{6c}\u{6f}\u{72}\u{3d}\u{22}\u{23}\u{46}\u{46}\u{46}\u{46}\u{46}\u{46}\u{22}\u{3e}\u{d}\u{a}\u{d}\u{a}\u{d}\u{a}\u{3c}\u{61}\u{20}\u{6e}\u{61}\u{6d}\u{65}\u{3d}\u{22}\u{6d}\u{61}\u{70}\u{22}\u{3e}\u{3c}\u{2f}\u{61}\u{3e}\u{d}\u{a}\u{d}\u{a}\u{3c}\u{74}\u{61}\u{62}\u{6c}\u{65}\u{20}\u{76}\u{61}\u{6c}\u{69}\u{67}\u{6e}\u{3d}\u{22}\u{74}\u{6f}\u{70}\u{22}\u{20}\u{63}\u{65}\u{6c}\u{6c}\u{70}\u{61}\u{64}\u{64}\u{69}\u{6e}\u{67}\u{3d}\u{30}\u{20}\u{63}\u{65}\u{6c}\u{6c}\u{73}\u{70}\u{61}\u{63}\u{69}\u{6e}\u{67}\u{3d}\u{30}\u{20}\u{62}\u{6f}\u{72}\u{64}\u{65}\u{72}\u{3d}\u{30}\u{20}\u{62}\u{61}\u{63}\u{6b}\u{67}\u{72}\u{6f}\u{75}\u{6e}\u{64}\u{3d}\u{22}"))
...
(assert (= literal_109 "\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{3c}\u{2f}\u{74}\u{72}\u{3e}\u{3c}\u{2f}\u{74}\u{61}\u{62}\u{6c}\u{65}\u{3e}\u{d}\u{a}\u{d}\u{a}\u{d}\u{a}\u{3c}\u{62}\u{72}\u{20}\u{2f}\u{3e}\u{d}\u{a}"))
