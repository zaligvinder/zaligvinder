...
(assert (= literal_34 "\u{3c}\u{61}\u{20}\u{74}\u{61}\u{72}\u{67}\u{65}\u{74}\u{3d}\u{22}\u{4c}\u{41}\u{4d}\u{53}\u{20}\u{41}\u{75}\u{74}\u{68}\u{6f}\u{72}\u{22}\u{20}\u{74}\u{69}\u{74}\u{6c}\u{65}\u{3d}\u{22}\u{4c}\u{41}\u{4d}\u{53}\u{20}\u{41}\u{75}\u{74}\u{68}\u{6f}\u{72}\u{22}\u{20}\u{68}\u{72}\u{65}\u{66}\u{3d}\u{22}"))
(assert (= x_35 (str.++ literal_34 x_33)))
(assert (= literal_38 "\u{22}\u{3e}"))
(assert (= x_39 (str.++ x_35 literal_38)))
(assert (= literal_37 "\u{6f}\u{70}\u{65}\u{6e}\u{61}\u{75}\u{74}\u{68}\u{6f}\u{72}"))
