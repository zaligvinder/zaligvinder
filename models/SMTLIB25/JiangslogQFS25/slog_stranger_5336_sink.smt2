...
(assert (= literal_2 "\u{3e}\u{d}\u{a}\u{20}\u{20}\u{20}\u{3c}\u{74}\u{64}\u{20}\u{61}\u{6c}\u{69}\u{67}\u{6e}\u{3d}\u{6c}\u{65}\u{66}\u{74}\u{27}\u{3e}"))
(assert (= epsilon ""))
...
(assert (= literal_9 "\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{d}\u{a}\u{20}\u{20}\u{20}\u{3c}\u{74}\u{64}\u{3e}"))
(assert (= x_10 (str.++ x_8 literal_9)))
(assert (= literal_11 "\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{d}\u{a}\u{20}\u{20}\u{20}\u{3c}\u{74}\u{64}\u{3e}"))
(assert (= x_12 (str.++ x_10 literal_11)))
(assert (= literal_18 "\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{d}\u{a}\u{20}\u{20}\u{20}\u{3c}\u{74}\u{64}\u{3e}"))
...
(assert (= literal_26 "\u{26}\u{23}\u{33}\u{37}\u{3b}\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{d}\u{a}\u{20}\u{20}\u{20}\u{3c}\u{74}\u{64}\u{3e}"))
...
(assert (= literal_37 "\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{d}\u{a}\u{20}\u{20}\u{20}"))
