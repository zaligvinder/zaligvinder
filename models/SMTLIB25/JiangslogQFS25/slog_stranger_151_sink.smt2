...
(assert (= literal_7 "\u{6c}\u{61}\u{6e}\u{67}\u{73}\u{2f}"))
(assert (= literal_5 ""))
(assert (or (= x_6 x_4) (= x_6 literal_5)))
(assert (= x_8 (str.++ literal_7 x_6)))
(assert (= literal_9 "\u{2e}\u{6a}\u{73}"))
(assert (= x_10 (str.++ x_8 literal_9)))
(assert (str.in_re sigmaStar_11 (re.++ (re.* re.allchar) (re.++ (str.to_re "\u{2f}\u{65}\u{76}\u{69}\u{6c}") (re.* re.allchar)))))
(check-sat)
(exit)
