...
(assert (= literal_2 "\u{3c}\u{2f}\u{68}\u{65}\u{61}\u{64}\u{3e}\u{d}\u{a}\u{3c}\u{62}\u{6f}\u{64}\u{79}\u{20}\u{62}\u{67}\u{63}\u{6f}\u{6c}\u{6f}\u{72}\u{3d}\u{27}"))
(assert (= x_3 (str.++ literal_2 sigmaStar_0)))
(assert (= literal_4 "\u{20}\u{74}\u{65}\u{78}\u{74}\u{3d}"))
(assert (= x_5 (str.++ x_3 literal_4)))
(assert (= x_6 (str.++ x_5 sigmaStar_1)))
(assert (= literal_7 "\u{27}\u{3e}\u{5c}\u{6e}"))
