...
(assert (= literal_12 "\u{42}\u{79}\u{74}\u{65}\u{73}"))
(assert (= x_14 (str.++ sigmaStar_0 literal_12)))
(assert (= x_20 (str.replace sigmaStar_3 "\u{2c}" "\u{20}")))
(assert (= literal_18 "\u{3c}\u{74}\u{72}\u{3e}\u{d}\u{a}\u{3c}\u{74}\u{64}\u{20}\u{77}\u{69}\u{64}\u{74}\u{68}\u{3d}\u{27}\u{31}\u{34}\u{35}\u{27}\u{20}\u{63}\u{6c}\u{61}\u{73}\u{73}\u{3d}\u{27}\u{74}\u{62}\u{6c}\u{32}\u{27}\u{3e}"))
...
(assert (= literal_31 "\u{3c}\u{2f}\u{73}\u{70}\u{61}\u{6e}\u{3e}\u{3c}\u{2f}\u{74}\u{64}\u{3e}\u{d}\u{a}\u{3c}\u{2f}\u{74}\u{72}\u{3e}\u{5c}\u{6e}"))
