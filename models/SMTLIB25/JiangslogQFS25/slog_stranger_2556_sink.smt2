...
(assert (= literal_35 "\u{20}\u{3c}\u{69}\u{6e}\u{70}\u{75}\u{74}\u{20}\u{74}\u{79}\u{70}\u{65}\u{3d}\u{5c}\u{22}\u{68}\u{69}\u{64}\u{64}\u{65}\u{6e}\u{5c}\u{22}\u{20}\u{6e}\u{61}\u{6d}\u{65}\u{3d}\u{5c}\u{22}\u{77}\u{64}\u{69}\u{72}\u{5c}\u{22}\u{20}\u{76}\u{61}\u{6c}\u{75}\u{65}\u{3d}\u{5c}\u{22}"))
(assert (or (= x_48 literal_2) (= x_48 literal_3) (= x_48 x_6)))
(assert (= x_49 (str.++ literal_35 x_48)))
(assert (= literal_50 "\u{5c}\u{22}\u{20}\u{2f}\u{3e}"))
