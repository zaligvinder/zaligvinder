...
(assert (= literal_2 "\u{20}\u{20}\u{69}\u{66}\u{20}\u{28}"))
(assert (= x_3 (str.++ literal_2 sigmaStar_0)))
(assert (= literal_4 "\u{5b}"))
(assert (= x_5 (str.++ x_3 literal_4)))
(assert (= x_6 (str.++ x_5 sigmaStar_0)))
(assert (= literal_7 "\u{5d}\u{2e}\u{63}\u{68}\u{65}\u{63}\u{6b}\u{65}\u{64}\u{29}\u{20}\u{65}\u{72}\u{72}\u{6f}\u{72}\u{3d}\u{74}\u{72}\u{75}\u{65}\u{3b}\u{5c}\u{6e}"))
