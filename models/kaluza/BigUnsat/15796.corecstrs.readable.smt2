...
(assert (ite T_SELECT_1 (and (= PCTEMP_LHS_1 (+ I0_5 0))(= var_0xINPUT_49455 (str.++ T0_5 T1_5))(= I0_5 (str.len T4_5))(= 0 (str.len T0_5))(= T1_5 (str.++ T2_5 T3_5))(= T2_5 (str.++ T4_5 T5_5))(= T5_5 "__utmv=218069774.")(not (str.in.re T4_5 (re.++   (str.to.re "_" )  (re.++   (str.to.re "_" ) (re.++  (str.to.re "u" ) (re.++  (str.to.re "t" ) (re.++  (str.to.re "m" ) (re.++  (str.to.re "v" ) (re.++  (str.to.re "=" ) (re.++  (str.to.re "2" ) (re.++  (str.to.re "1" ) (re.++  (str.to.re "8" ) (re.++  (str.to.re "0" ) (re.++  (str.to.re "6" ) (re.++  (str.to.re "9" ) (re.++  (str.to.re "7" ) (re.++  (str.to.re "7" ) (re.++  (str.to.re "4" )  (str.to.re "." )  ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ))) (and (= PCTEMP_LHS_1 (- 1))(= var_0xINPUT_49455 (str.++ T0_5 T1_5))(= 0 (str.len T0_5))(not (str.in.re T1_5 (re.++   (str.to.re "_" )  (re.++   (str.to.re "_" ) (re.++  (str.to.re "u" ) (re.++  (str.to.re "t" ) (re.++  (str.to.re "m" ) (re.++  (str.to.re "v" ) (re.++  (str.to.re "=" ) (re.++  (str.to.re "2" ) (re.++  (str.to.re "1" ) (re.++  (str.to.re "8" ) (re.++  (str.to.re "0" ) (re.++  (str.to.re "6" ) (re.++  (str.to.re "9" ) (re.++  (str.to.re "7" ) (re.++  (str.to.re "7" ) (re.++  (str.to.re "4" )  (str.to.re "." )  ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )))))
