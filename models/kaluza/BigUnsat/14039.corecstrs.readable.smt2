...
(assert (= var_0xINPUT_47773 (str.++ T1_14 T2_14)))
(assert (= T2_14 (str.++ PCTEMP_LHS_3 T3_14)))
(assert (= T_a (str.len T1_14)))
(assert (= I1_14 (str.len var_0xINPUT_47773)))
(assert (= T_d (= "-" T_c)))
(assert T_d)
(assert (= T_f (= "-" T_e)))
(assert T_f)
...
(assert T_28)
(assert (= T_29 (= "-" PCTEMP_LHS_3)))
(assert (= T_2a (not T_29)))
(assert T_2a)
(assert (= T_2b (= "" PCTEMP_LHS_3)))
(assert (= T_2c (not T_2b)))
(assert T_2c)
(assert (= T_2d (= "" PCTEMP_LHS_3)))
