...
(assert (= T2_7 var_0xINPUT_100845))
(assert (= T1_7 ""))
(assert (= T_5 (= "" T_4)))
(assert T_5)
(assert (= T_6 (str.++ T1_10 T2_10)))
(assert (= T2_10 var_0xINPUT_100845))
(assert (= T1_10 ""))
...
(assert (= T2_17 var_0xINPUT_100845))
(assert (= T1_17 ""))
(assert (= T_b (= "-" T_a)))
(assert (= T_c (not T_b)))
(assert T_c)
(assert (= T_d (str.++ T1_20 T2_20)))
(assert (= T2_20 var_0xINPUT_100845))
(assert (= T1_20 ""))
(assert (= T_e (= "" T_d)))
(assert T_e)
(assert (= T_f (str.++ T1_23 T2_23)))
(assert (= T2_23 var_0xINPUT_100845))
(assert (= T1_23 ""))
...
(assert (= T2_30 var_0xINPUT_100845))
(assert (= T1_30 ""))
(assert (= T_14 (= "-" T_13)))
(assert (= T_15 (not T_14)))
(assert T_15)
(assert (= T_16 (str.++ T1_33 T2_33)))
(assert (= T2_33 var_0xINPUT_100845))
(assert (= T1_33 ""))
(assert (= T_17 (= "" T_16)))
(assert T_17)
(assert (= T_18 (str.++ T1_36 T2_36)))
(assert (= T2_36 var_0xINPUT_100845))
(assert (= T1_36 ""))
...
(assert (= T2_42 var_0xINPUT_100845))
(assert (= T1_42 ""))
(assert (= T_1d (= "-" T_1c)))
(assert T_1d)
(check-sat)
