...
(assert (= T2_8 var_0xINPUT_13139))
(assert (= T1_8 ""))
(assert (= T_5 (= T_4 "")))
(assert (= T_6 (not T_5)))
(assert T_6)
(assert (= T_7 (str.++ T1_11 T2_11)))
(assert (= T2_11 var_0xINPUT_13139))
(assert (= T1_11 ""))
...
(assert (= T2_18 var_0xINPUT_13139))
(assert (= T1_18 ""))
(assert (= T_c (= "" T_b)))
(assert (= T_d (not T_c)))
(assert T_d)
(assert (= T_e (str.++ T1_22 T2_22)))
(assert (= T2_22 var_0xINPUT_13139))
(assert (= T1_22 ""))
(assert (= T_f (= T_e "")))
(assert (= T_10 (not T_f)))
(assert T_10)
(assert (= T_11 (str.++ T1_25 T2_25)))
(assert (= T2_25 var_0xINPUT_13139))
(assert (= T1_25 ""))
