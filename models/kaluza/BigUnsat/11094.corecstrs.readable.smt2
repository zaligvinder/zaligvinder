...
(declare-fun T_5f () String)
(declare-fun T_60 () String)
...
(assert T_4b)
(assert (= T_4c (str.++ "url(" PCTEMP_LHS_7)))
(assert (= T_4d (str.++ T_4c ")")))
(assert (= T_4e (= "" T_4d)))
(assert T_4e)
(assert (= T_4f (str.++ "url(" PCTEMP_LHS_7)))
(assert (= T_50 (str.++ T_4f ")")))
(assert (= T_51 (not (= T_50 "string"))))
(assert (= T_52 (not T_51)))
(assert T_52)
(assert (= T_53 (str.++ "url(" PCTEMP_LHS_7)))
(assert (= T_54 (str.++ T_53 ")")))
(assert (= T_55 (not (= T_54 "string"))))
(assert (= T_56 (not T_55)))
(assert T_56)
(assert (= T_57 (str.++ "url(" PCTEMP_LHS_7)))
(assert (= T_58 (str.++ T_57 ")")))
(assert (= T_59 (not (= T_58 "string"))))
(assert (= T_5a (not T_59)))
(assert T_5a)
(assert (= T_5b (str.++ "url(" PCTEMP_LHS_7)))
(assert (= T_5c (str.++ T_5b ")")))
(assert (= T_5d (not (= T_5c "string"))))
(assert (= T_5e (not T_5d)))
(assert T_5e)
(assert (= T_5f (str.++ "url(" PCTEMP_LHS_7)))
(assert (= T_60 (str.++ T_5f ")")))
(assert (= T_61 (not (= "" T_60))))
(assert T_61)
(assert (= T_62 (str.++ "url(" PCTEMP_LHS_7)))
(assert (= T_63 (str.++ T_62 ")")))
(assert (= T_65 (not T_64)))
(assert T_65)
(assert (= T_66 (str.++ "url(" PCTEMP_LHS_7)))
(assert (= T_67 (str.++ T_66 ")")))
(assert (= T_69 (not T_68)))
(assert T_69)
(assert (= T_6a (str.++ "url(" PCTEMP_LHS_7)))
(assert (= T_6b (str.++ T_6a ")")))
(assert (= T_6d (not T_6c)))
(assert T_6d)
(check-sat)
