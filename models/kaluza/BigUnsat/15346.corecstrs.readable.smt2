...
(assert (= var_0xINPUT_36716 (str.++ T1_18 T2_18)))
(assert (= T2_18 (str.++ PCTEMP_LHS_4 T3_18)))
(assert (= T_d (str.len T1_18)))
(assert (= I1_18 (str.len var_0xINPUT_36716)))
