...
(assert T_42)
(assert (= T_43 (str.len PCTEMP_LHS_7)))
(assert (= T_44 (- T_43 1)))
(assert (= T_45 (not (= 0 T_44))))
(assert (= T_46 (not T_45)))
(assert T_46)
(assert (= T_47 PCTEMP_LHS_7_idx_0))
(assert (= T_49 (not (= "" T_48))))
(assert T_49)
(assert (= T_4a PCTEMP_LHS_7_idx_0))
(assert (= T_4d (= PCTEMP_LHS_12 "TABLE")))
(assert (= T_4e (not T_4d)))
(assert T_4e)
(assert (= T_4f (= PCTEMP_LHS_12 "TABLE")))
