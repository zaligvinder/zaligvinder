...
(assert (ite T_SELECT_1 (and (= PCTEMP_LHS_1 (+ I0_12 0))(= T_7 (str.++ T0_12 T1_12))(= I0_12 (str.len T4_12))(= 0 (str.len T0_12))(= T1_12 (str.++ T2_12 T3_12))(= T2_12 (str.++ T4_12 T5_12))(= T5_12 "utm_id=")(not (str.in_re T4_12 (re.++   (str.to_re "u" )  (re.++   (str.to_re "t" ) (re.++  (str.to_re "m" ) (re.++  (str.to_re "_" ) (re.++  (str.to_re "i" ) (re.++  (str.to_re "d" )  (str.to_re "=" )  ) ) ) ) ) ) ))) (and (= PCTEMP_LHS_1 (- 1))(= T_7 (str.++ T0_12 T1_12))(= 0 (str.len T0_12))(not (str.in_re T1_12 (re.++   (str.to_re "u" )  (re.++   (str.to_re "t" ) (re.++  (str.to_re "m" ) (re.++  (str.to_re "_" ) (re.++  (str.to_re "i" ) (re.++  (str.to_re "d" )  (str.to_re "=" )  ) ) ) ) ) ) )))))
...
(assert (ite T_SELECT_2 (and (= PCTEMP_LHS_2 (+ I0_26 0))(= T_11 (str.++ T0_26 T1_26))(= I0_26 (str.len T4_26))(= 0 (str.len T0_26))(= T1_26 (str.++ T2_26 T3_26))(= T2_26 (str.++ T4_26 T5_26))(= T5_26 "utm_source=")(not (str.in_re T4_26 (re.++   (str.to_re "u" )  (re.++   (str.to_re "t" ) (re.++  (str.to_re "m" ) (re.++  (str.to_re "_" ) (re.++  (str.to_re "s" ) (re.++  (str.to_re "o" ) (re.++  (str.to_re "u" ) (re.++  (str.to_re "r" ) (re.++  (str.to_re "c" ) (re.++  (str.to_re "e" )  (str.to_re "=" )  ) ) ) ) ) ) ) ) ) ) ))) (and (= PCTEMP_LHS_2 (- 1))(= T_11 (str.++ T0_26 T1_26))(= 0 (str.len T0_26))(not (str.in_re T1_26 (re.++   (str.to_re "u" )  (re.++   (str.to_re "t" ) (re.++  (str.to_re "m" ) (re.++  (str.to_re "_" ) (re.++  (str.to_re "s" ) (re.++  (str.to_re "o" ) (re.++  (str.to_re "u" ) (re.++  (str.to_re "r" ) (re.++  (str.to_re "c" ) (re.++  (str.to_re "e" )  (str.to_re "=" )  ) ) ) ) ) ) ) ) ) ) )))))
(assert (= T_13 (< (- 1) PCTEMP_LHS_2)))
(assert (= T_14 (not T_13)))
(assert T_14)
(assert (= T_15 (str.++ T1_32 T2_32)))
(assert (= T2_32 var_0xINPUT_16152))
(assert (= T1_32 ""))
(assert (= T_16 (= "" T_15)))
(assert (= T_17 (not T_16)))
(assert T_17)
(assert (= T_18 (str.++ T1_36 T2_36)))
(assert (= T2_36 var_0xINPUT_16152))
(assert (= T1_36 ""))
(assert (= T_19 (= T_18 "")))
(assert (= T_1a (not T_19)))
(assert T_1a)
(assert (= T_1b (str.++ T1_39 T2_39)))
(assert (= T2_39 var_0xINPUT_16152))
(assert (= T1_39 ""))
(assert (= T_SELECT_3 (not (= PCTEMP_LHS_3 (- 1)))))
(assert (ite T_SELECT_3 (and (= PCTEMP_LHS_3 (+ I0_40 0))(= T_1b (str.++ T0_40 T1_40))(= I0_40 (str.len T4_40))(= 0 (str.len T0_40))(= T1_40 (str.++ T2_40 T3_40))(= T2_40 (str.++ T4_40 T5_40))(= T5_40 "gclid=")(not (str.in_re T4_40 (re.++   (str.to_re "g" )  (re.++   (str.to_re "c" ) (re.++  (str.to_re "l" ) (re.++  (str.to_re "i" ) (re.++  (str.to_re "d" )  (str.to_re "=" )  ) ) ) ) ) ))) (and (= PCTEMP_LHS_3 (- 1))(= T_1b (str.++ T0_40 T1_40))(= 0 (str.len T0_40))(not (str.in_re T1_40 (re.++   (str.to_re "g" )  (re.++   (str.to_re "c" ) (re.++  (str.to_re "l" ) (re.++  (str.to_re "i" ) (re.++  (str.to_re "d" )  (str.to_re "=" )  ) ) ) ) ) )))))
