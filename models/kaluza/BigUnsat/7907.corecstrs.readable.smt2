...
(assert (ite T_SELECT_3 (and (= PCTEMP_LHS_5 (+ I0_27 0))(= var_0xINPUT_10765 (str.++ T0_27 T1_27))(= I0_27 (str.len T4_27))(= 0 (str.len T0_27))(= T1_27 (str.++ T2_27 T3_27))(= T2_27 (str.++ T4_27 T5_27))(= T5_27 "__utmx=169413169")(not (str.in_re T4_27 (re.++   (str.to_re "_" )  (re.++   (str.to_re "_" ) (re.++  (str.to_re "u" ) (re.++  (str.to_re "t" ) (re.++  (str.to_re "m" ) (re.++  (str.to_re "x" ) (re.++  (str.to_re "=" ) (re.++  (str.to_re "1" ) (re.++  (str.to_re "6" ) (re.++  (str.to_re "9" ) (re.++  (str.to_re "4" ) (re.++  (str.to_re "1" ) (re.++  (str.to_re "3" ) (re.++  (str.to_re "1" ) (re.++  (str.to_re "6" )  (str.to_re "9" )  ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ))) (and (= PCTEMP_LHS_5 (- 1))(= var_0xINPUT_10765 (str.++ T0_27 T1_27))(= 0 (str.len T0_27))(not (str.in_re T1_27 (re.++   (str.to_re "_" )  (re.++   (str.to_re "_" ) (re.++  (str.to_re "u" ) (re.++  (str.to_re "t" ) (re.++  (str.to_re "m" ) (re.++  (str.to_re "x" ) (re.++  (str.to_re "=" ) (re.++  (str.to_re "1" ) (re.++  (str.to_re "6" ) (re.++  (str.to_re "9" ) (re.++  (str.to_re "4" ) (re.++  (str.to_re "1" ) (re.++  (str.to_re "3" ) (re.++  (str.to_re "1" ) (re.++  (str.to_re "6" )  (str.to_re "9" )  ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )))))
...
(assert (ite T_SELECT_6 (and (= PCTEMP_LHS_10 (+ I0_57 0))(= var_0xINPUT_10765 (str.++ T0_57 T1_57))(= I0_57 (str.len T4_57))(= 0 (str.len T0_57))(= T1_57 (str.++ T2_57 T3_57))(= T2_57 (str.++ T4_57 T5_57))(= T5_57 "__utmv=169413169.")(not (str.in_re T4_57 (re.++   (str.to_re "_" )  (re.++   (str.to_re "_" ) (re.++  (str.to_re "u" ) (re.++  (str.to_re "t" ) (re.++  (str.to_re "m" ) (re.++  (str.to_re "v" ) (re.++  (str.to_re "=" ) (re.++  (str.to_re "1" ) (re.++  (str.to_re "6" ) (re.++  (str.to_re "9" ) (re.++  (str.to_re "4" ) (re.++  (str.to_re "1" ) (re.++  (str.to_re "3" ) (re.++  (str.to_re "1" ) (re.++  (str.to_re "6" ) (re.++  (str.to_re "9" )  (str.to_re "." )  ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ))) (and (= PCTEMP_LHS_10 (- 1))(= var_0xINPUT_10765 (str.++ T0_57 T1_57))(= 0 (str.len T0_57))(not (str.in_re T1_57 (re.++   (str.to_re "_" )  (re.++   (str.to_re "_" ) (re.++  (str.to_re "u" ) (re.++  (str.to_re "t" ) (re.++  (str.to_re "m" ) (re.++  (str.to_re "v" ) (re.++  (str.to_re "=" ) (re.++  (str.to_re "1" ) (re.++  (str.to_re "6" ) (re.++  (str.to_re "9" ) (re.++  (str.to_re "4" ) (re.++  (str.to_re "1" ) (re.++  (str.to_re "3" ) (re.++  (str.to_re "1" ) (re.++  (str.to_re "6" ) (re.++  (str.to_re "9" )  (str.to_re "." )  ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) )))))
...
(assert (= T1_80 T_36))
(assert (= T_38 (str.++ "http://www.google-analytics.com/__utm.gif?utmwv=1.3&utmn=1332076825&utmcs=UTF-8&utmsr=1680x976&utmsc=24-bit&utmul=en-us&utmje=0&utmfl=-&utmcn=1&utmdt=Ask%20A%20Word&utmhn=www.askaword.com&utmhid=1325034730&utmr=0&utmp=/search.jsp?d=gg&utmac=UA-167675-3&utmcc=" T_37)))
(check-sat)
