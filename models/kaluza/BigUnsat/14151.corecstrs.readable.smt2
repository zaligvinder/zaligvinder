...
(assert (= var_0xINPUT_47629 (str.++ T1_14 T2_14)))
(assert (= T2_14 (str.++ PCTEMP_LHS_3 T3_14)))
(assert (= T_a (str.len T1_14)))
(assert (= I1_14 (str.len var_0xINPUT_47629)))
(assert (= T_d (= "-" T_c)))
(assert T_d)
(assert (= T_f (= "-" T_e)))
(assert T_f)
