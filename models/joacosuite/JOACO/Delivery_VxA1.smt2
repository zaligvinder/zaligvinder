...
(assert (= true (= sv1 sv2 ) ))
(assert (= true (str.in_re var180 (re.++ (re.++ (re.++  (re.++ (re.* re.allchar ) (re.++  (str.to_re "'") (re.++ (re.+  (str.to_re " ") ) (re.++  (re.union  (str.to_re "O")  (str.to_re "o")) (re.++  (re.union  (str.to_re "R")  (str.to_re "r")) (re.++ (re.+  (str.to_re " ") )  (str.to_re "'"))))))) (str.to_re sv1) ) (re.++  (re.++  (str.to_re "'") (re.++ (re.* re.allchar ) (re.++  (str.to_re "=") (re.++ (re.* re.allchar )  (str.to_re "'"))))) (str.to_re sv2) ) )  (re.++  (str.to_re "'") (re.++ (re.*  (str.to_re " ") )  (re.union  (re.++  (str.to_re "\u{2d}")  (str.to_re "\u{2d}"))  (str.to_re "\u{23}")))) ) ) ))
...
(assert (= true (= (str.++ var136 (str.from_int var101 ) ) var135 ) ))
(assert (= true (= (str.++ var137 "AND o_d_id =" ) var136 ) ))
(assert (= true (= (str.++ var138 (str.from_int var105 ) ) var137 ) ))
...
(assert (= true (= (str.++ var158 "\u{29} WHERE rownum = 1" ) var157 ) ))
...
(assert (= true (= (str.++ var165 (str.from_int var101 ) ) var163 ) ))
...
(assert (= true (= (str.++ var172 "SELECT \u{2a} FROM \u{28}" ) var170 ) ))
...
(assert (= true (= (str.++ var100 (str.from_int var101 ) ) var98 ) ))
(assert (= true (= (str.++ var102 "AND ol_d_id =" ) var100 ) ))
(assert (= true (= (str.++ var104 (str.from_int var105 ) ) var102 ) ))
...
(assert (= true (= (str.++ var119 (str.from_int var101 ) ) var117 ) ))
(assert (= true (= (str.++ var120 "AND o_d_id =" ) var119 ) ))
(assert (= true (= (str.++ var122 (str.from_int var105 ) ) var120 ) ))
