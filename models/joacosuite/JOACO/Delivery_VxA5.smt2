...
(assert (= true (= sv1 sv2 ) ))
(assert (= true (str.in_re var547 (re.++ (re.++ (re.++  (re.++ (re.* re.allchar ) (re.++  (str.to_re "'") (re.++ (re.+  (str.to_re " ") ) (re.++  (re.union  (str.to_re "O")  (str.to_re "o")) (re.++  (re.union  (str.to_re "R")  (str.to_re "r")) (re.++ (re.+  (str.to_re " ") )  (str.to_re "'"))))))) (str.to_re sv1) ) (re.++  (re.++  (str.to_re "'") (re.++ (re.* re.allchar ) (re.++  (str.to_re "=") (re.++ (re.* re.allchar )  (str.to_re "'"))))) (str.to_re sv2) ) )  (re.++  (str.to_re "'") (re.++ (re.*  (str.to_re " ") )  (re.union  (re.++  (str.to_re "\u{2d}")  (str.to_re "\u{2d}"))  (str.to_re "\u{23}")))) ) ) ))
(assert (= true (= (str.++ var495 var496 ) var493 ) ))
(assert (= true (= (str.++ var497 "AND o_w_id = '" ) var495 ) ))
(assert (= true (= (str.++ var499 (str.from_int var500 ) ) var497 ) ))
(assert (= true (= (str.++ var501 "AND o_d_id =" ) var499 ) ))
(assert (= true (= (str.++ var503 (str.from_int var504 ) ) var501 ) ))
...
(assert (= true (= (str.++ var526 "\u{29} WHERE rownum = 1" ) var525 ) ))
...
(assert (= true (= (str.++ var533 (str.from_int var500 ) ) var531 ) ))
...
(assert (= true (= (str.++ var540 "SELECT \u{2a} FROM \u{28}" ) var538 ) ))
