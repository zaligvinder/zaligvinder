...
(assert (= true (= sv1 sv2 ) ))
(assert (= true (str.in_re var430 (re.++ (re.++ (re.++  (re.++ (re.* re.allchar ) (re.++  (str.to_re "'") (re.++ (re.+  (str.to_re " ") ) (re.++  (re.union  (str.to_re "O")  (str.to_re "o")) (re.++  (re.union  (str.to_re "R")  (str.to_re "r")) (re.++ (re.+  (str.to_re " ") )  (str.to_re "'"))))))) (str.to_re sv1) ) (re.++  (re.++  (str.to_re "'") (re.++ (re.* re.allchar ) (re.++  (str.to_re "=") (re.++ (re.* re.allchar )  (str.to_re "'"))))) (str.to_re sv2) ) )  (re.++  (str.to_re "'") (re.++ (re.*  (str.to_re " ") )  (re.union  (re.++  (str.to_re "\u{2d}")  (str.to_re "\u{2d}"))  (str.to_re "\u{23}")))) ) ) ))
...
(assert (= true (= (str.++ var404 "SELECT \u{2a} FROM \u{28}" ) var402 ) ))
...
(assert (= true (= (str.++ var363 (str.from_int var364 ) ) var361 ) ))
...
(assert (= true (or (= var376 var378 ) (= (str.to_int var376 ) (- 1) ) ) ))
(assert (= true (or (= var364 (- 1) ) (= var364 var379 ) ) ))
(assert (= true (= 0 var380 ) ))
(assert (= true (= var385 var384 ) ))
(assert (= true (= (str.++ var386 "\u{29} WHERE rownum = 1" ) var385 ) ))
