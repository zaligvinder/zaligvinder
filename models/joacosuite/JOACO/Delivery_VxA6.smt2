...
(assert (= true (= sv1 sv2 ) ))
(assert (= true (str.in_re var709 (re.++ (re.++ (re.++  (re.++ (re.* re.allchar ) (re.++  (str.to_re "'") (re.++ (re.+  (str.to_re " ") ) (re.++  (re.union  (str.to_re "O")  (str.to_re "o")) (re.++  (re.union  (str.to_re "R")  (str.to_re "r")) (re.++ (re.+  (str.to_re " ") )  (str.to_re "'"))))))) (str.to_re sv1) ) (re.++  (re.++  (str.to_re "'") (re.++ (re.* re.allchar ) (re.++  (str.to_re "=") (re.++ (re.* re.allchar )  (str.to_re "'"))))) (str.to_re sv2) ) )  (re.++  (str.to_re "'") (re.++ (re.*  (str.to_re " ") )  (re.union  (re.++  (str.to_re "\u{2d}")  (str.to_re "\u{2d}"))  (str.to_re "\u{23}")))) ) ) ))
...
(assert (= true (= (str.++ var616 (str.from_int var617 ) ) var614 ) ))
(assert (= true (= (str.++ var618 "AND ol_d_id =" ) var616 ) ))
(assert (= true (= (str.++ var620 (str.from_int var621 ) ) var618 ) ))
(assert (= true (= (str.++ var622 "WHERE ol_o_id =" ) var620 ) ))
(assert (= true (= (str.++ var624 "FROM tpcc_order_line" ) var622 ) ))
(assert (= true (= (str.++ var626 "SELECT SUM\u{28}ol_amount\u{29} AS ol_total" ) var624 ) ))
...
(assert (= true (= (str.++ var636 (str.from_int var617 ) ) var635 ) ))
(assert (= true (= (str.++ var637 "AND ol_d_id =" ) var636 ) ))
(assert (= true (= (str.++ var638 (str.from_int var621 ) ) var637 ) ))
...
(assert (= true (= (str.++ var649 (str.from_int var617 ) ) var647 ) ))
(assert (= true (= (str.++ var650 "AND o_d_id =" ) var649 ) ))
(assert (= true (= (str.++ var652 (str.from_int var621 ) ) var650 ) ))
...
(assert (= true (= (str.++ var666 (str.from_int var617 ) ) var665 ) ))
(assert (= true (= (str.++ var667 "AND o_d_id =" ) var666 ) ))
(assert (= true (= (str.++ var668 (str.from_int var621 ) ) var667 ) ))
...
(assert (= true (= (str.++ var688 "\u{29} WHERE rownum = 1" ) var687 ) ))
...
(assert (= true (= (str.++ var695 (str.from_int var617 ) ) var693 ) ))
...
(assert (= true (= (str.++ var702 "SELECT \u{2a} FROM \u{28}" ) var700 ) ))
