...
(assert (= true (= sv1 sv2 ) ))
(assert (= true (str.in_re var348 (re.++ (re.++ (re.++  (re.++ (re.* re.allchar ) (re.++  (str.to_re "'") (re.++ (re.+  (str.to_re " ") ) (re.++  (re.union  (str.to_re "O")  (str.to_re "o")) (re.++  (re.union  (str.to_re "R")  (str.to_re "r")) (re.++ (re.+  (str.to_re " ") )  (str.to_re "'"))))))) (str.to_re sv1) ) (re.++  (re.++  (str.to_re "'") (re.++ (re.* re.allchar ) (re.++  (str.to_re "=") (re.++ (re.* re.allchar )  (str.to_re "'"))))) (str.to_re sv2) ) )  (re.++  (str.to_re "'") (re.++ (re.*  (str.to_re " ") )  (re.union  (re.++  (str.to_re "\u{2d}")  (str.to_re "\u{2d}"))  (str.to_re "\u{23}")))) ) ) ))
...
(assert (= true (= (str.++ var282 (str.from_int var283 ) ) var280 ) ))
...
(assert (= true (or (= var295 var297 ) (= (str.to_int var295 ) (- 1) ) ) ))
(assert (= true (or (= var283 var298 ) (= var283 (- 1) ) ) ))
(assert (= true (= 0 var299 ) ))
(assert (= true (= var304 var303 ) ))
(assert (= true (= (str.++ var305 "\u{29} WHERE rownum = 1" ) var304 ) ))
...
(assert (= true (= (str.++ var323 "SELECT \u{2a} FROM \u{28}" ) var321 ) ))
