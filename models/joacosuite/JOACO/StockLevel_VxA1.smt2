...
(assert (= true (= sv1 sv2 ) ))
(assert (= true (str.in_re var113 (re.++ (re.++ (re.++  (re.++ (re.* re.allchar ) (re.++  (str.to_re "'") (re.++ (re.+  (str.to_re " ") ) (re.++  (re.union  (str.to_re "O")  (str.to_re "o")) (re.++  (re.union  (str.to_re "R")  (str.to_re "r")) (re.++ (re.+  (str.to_re " ") )  (str.to_re "'"))))))) (str.to_re sv1) ) (re.++  (re.++  (str.to_re "'") (re.++ (re.* re.allchar ) (re.++  (str.to_re "=") (re.++ (re.* re.allchar )  (str.to_re "'"))))) (str.to_re sv2) ) )  (re.++  (str.to_re "'") (re.++ (re.*  (str.to_re " ") )  (re.union  (re.++  (str.to_re "\u{2d}")  (str.to_re "\u{2d}"))  (str.to_re "\u{23}")))) ) ) ))
...
(assert (= true (= (str.++ var67 (str.from_int var68 ) ) var65 ) ))
(assert (= true (= (str.++ var69 "AND ol_o_id \u{3e}=" ) var67 ) ))
(assert (= true (= (str.++ var71 (str.from_int var72 ) ) var69 ) ))
(assert (= true (= (str.++ var73 "' AND ol_o_id \u{3c}" ) var71 ) ))
...
(assert (= true (= (str.++ var82 (str.from_int var83 ) ) var80 ) ))
(assert (= true (= (str.++ var84 "AND s_quantity \u{3c}" ) var82 ) ))
(assert (= true (= (str.++ var86 "WHERE s_i_id = ol_i_id" ) var84 ) ))
(assert (= true (= (str.++ var88 "FROM tpcc_order_line, tpcc_stock" ) var86 ) ))
(assert (= true (= (str.++ var90 "SELECT COUNT\u{28}DISTINCT \u{28}s_i_id\u{29}\u{29} AS stock_count" ) var88 ) ))
