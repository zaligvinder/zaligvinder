...
(assert (= true (= (str.++ var844 "\u{29} WHERE rownum = 1" ) var843 ) ))
...
(assert (= true (= (str.++ var850 (str.from_int var827 ) ) var849 ) ))
...
(assert (= true (= (str.++ var856 "SELECT \u{2a} FROM \u{28}" ) var854 ) ))
