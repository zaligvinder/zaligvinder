...
(set-logic QF_S)(declare-fun var0 () String)(declare-fun var1 () String)(declare-fun var2 () String)(declare-fun var3 () String)(declare-fun var4 () String)(declare-fun var5 () Int)(declare-fun var6 () Int)(declare-fun var7 () Int)(declare-fun var8 () Int)(declare-fun var9 () Int)(declare-fun var10 () Bool)(declare-fun var11 () Bool)(declare-fun var12 () Bool)(declare-fun var13 () Bool)(declare-fun var14 () Bool)(assert (not (str.contains var0 var2)))(assert (str.in.re (str.substr var2 var6 var5) (re.+ (re.* re.allchar))))(assert (str.suffixof (str.at (str.substr var3 5 var7) (str.len var4)) (str.at var1 var9)))(assert (>= 9 var5))(assert (< (str.indexof "b\\\\;wmL{vL" var0 var6) (str.len var3)))(check-sat)