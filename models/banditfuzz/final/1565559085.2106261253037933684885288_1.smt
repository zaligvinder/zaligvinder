...
(set-logic ALL)(declare-fun var0 () String)(declare-fun var1 () String)(declare-fun var2 () String)(declare-fun var3 () String)(declare-fun var4 () String)(declare-fun var5 () String)(declare-fun var6 () Int)(declare-fun var7 () Int)(declare-fun var8 () Int)(declare-fun var9 () Int)(declare-fun var10 () Int)(declare-fun var11 () Int)(declare-fun var12 () Bool)(declare-fun var13 () Bool)(declare-fun var14 () Bool)(declare-fun var15 () Bool)(declare-fun var16 () Bool)(declare-fun var17 () Bool)(assert (not (str.in_re var1 re.allchar)))(assert (> (str.indexof var5 var4 var10) (str.len "%/B_NE4-<p")))(assert (str.contains (str.replace var4 var3 ">""xBa[3LPG") (str.at "?-%$)GmECp" 6)))(assert (< (str.to_int var0) (str.indexof (str.at var3 var10) (str.substr var1 (str.len var0) (str.indexof var4 var1 var10)) (str.len "+-nfhMQJ*:"))))(assert (not var13))(check-sat)