...
(set-logic ALL)(declare-fun var0 () String)(declare-fun var1 () String)(declare-fun var2 () String)(declare-fun var3 () String)(declare-fun var4 () String)(declare-fun var5 () Int)(declare-fun var6 () Int)(declare-fun var7 () Int)(declare-fun var8 () Int)(declare-fun var9 () Int)(declare-fun var10 () Bool)(declare-fun var11 () Bool)(declare-fun var12 () Bool)(declare-fun var13 () Bool)(declare-fun var14 () Bool)(assert (str.suffixof ".X71A{,*{6" "{'&d/7l37<"))(assert (str.in_re (str.at var4 var9) (re.+ re.allchar)))(assert (str.in_re (str.replace "-""@tZC{crD" var1 "w7i3ft>B}a") (re.* re.allchar)))(assert (str.in_re (str.replace var1 var4 var3) (re.* re.allchar)))(assert (> (str.indexof (str.replace var4 var1 var3) (str.at var2 var8) (str.indexof var2 var1 var8)) (str.len (str.substr var3 var5 var5))))(check-sat)