...
(set-logic QF_S)(declare-fun var0 () String)(declare-fun var1 () String)(declare-fun var2 () String)(declare-fun var3 () String)(declare-fun var4 () String)(declare-fun var5 () Int)(declare-fun var6 () Int)(declare-fun var7 () Int)(declare-fun var8 () Int)(declare-fun var9 () Int)(declare-fun var10 () Bool)(declare-fun var11 () Bool)(declare-fun var12 () Bool)(declare-fun var13 () Bool)(declare-fun var14 () Bool)(assert (>= (str.indexof var3 var0 var5) (str.len var3)))(assert (str.in.re (str.replace var2 var0 var4) (re.+ re.allchar)))(assert (str.suffixof var3 var1))(assert (not (not (> var7 1))))(assert (str.in.re var1 re.allchar))(check-sat)