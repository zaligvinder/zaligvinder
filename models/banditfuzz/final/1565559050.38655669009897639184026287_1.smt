...
(set-logic ALL)(declare-fun var0 () String)(declare-fun var1 () String)(declare-fun var2 () String)(declare-fun var3 () String)(declare-fun var4 () String)(declare-fun var5 () String)(declare-fun var6 () Int)(declare-fun var7 () Int)(declare-fun var8 () Int)(declare-fun var9 () Int)(declare-fun var10 () Int)(declare-fun var11 () Int)(declare-fun var12 () Bool)(declare-fun var13 () Bool)(declare-fun var14 () Bool)(declare-fun var15 () Bool)(declare-fun var16 () Bool)(declare-fun var17 () Bool)(assert (str.in_re (str.replace (str.at var3 var10) (str.replace var2 var0 var1) (str.replace var1 "*.Ra7!TD9E" "XR}~?7;mJ;")) (re.* (re.* re.allchar))))(assert (not (str.suffixof "Qa.)QYSoKa" var0)))(assert (str.in_re (str.substr (str.replace var5 var5 var5) (str.len var1) (str.len var1)) (re.+ (re.+ re.allchar))))(assert (>= var10 var11))(assert (> (str.indexof var1 var5 var11) (str.len "nwQBk]ylDx")))(check-sat)