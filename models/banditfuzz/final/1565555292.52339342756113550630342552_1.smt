...
(set-logic QF_S)(declare-fun var0 () String)(declare-fun var1 () String)(declare-fun var2 () String)(declare-fun var3 () String)(declare-fun var4 () String)(declare-fun var5 () Int)(declare-fun var6 () Int)(declare-fun var7 () Int)(declare-fun var8 () Int)(declare-fun var9 () Int)(declare-fun var10 () Bool)(declare-fun var11 () Bool)(declare-fun var12 () Bool)(declare-fun var13 () Bool)(declare-fun var14 () Bool)(assert (str.suffixof (str.replace var0 var3 var0) (str.replace "2Upss4Eb-3" var1 "+dzDw}d+xI")))(assert (str.in.re (str.replace var0 var1 var1) (re.+ re.allchar)))(assert (str.contains (str.at var2 var5) (str.at (str.substr var0 var8 var6) (str.indexof var4 var2 var6))))(assert (str.prefixof var1 var4))(assert (not (>= (str.len var2) (str.len var0))))(check-sat)