...
(assert (= true (= true (= s778 "\u{2a}\u{2a}Options:\u{2a}" ) ) ))
...
(assert (= true (= true (= s850 "\u{29}sql\u{29}\u{29}\u{29}SQL output\u{2a}" ) ) ))
...
(assert (= true (= true (= s814 "\u{29}\u{2d}\u{2d}help\u{29}\u{29}\u{29}Displays this screen\u{2a}\u{2a}" ) ) ))
...
(assert (= true (= true (= s868 "\u{29}html\u{29}\u{29}\u{29}HTML output\u{2a}" ) ) ))
(assert (= true (= true (= s854 s849 ) ) ))
(assert (= true (= true (= s31 "\u{2d}\u{2d}" ) ) ))
(assert (= true (= true (= s743 "html" ) ) ))
(assert (= true (= true (= s753 s746 ) ) ))
(assert (= true (= true (= s796 "\u{29}\u{2d}\u{2d}version\u{29}\u{29}Displays version information\u{2a}" ) ) ))
(assert (= true (= true (= s736 "sql" ) ) ))
(assert (= true (= true (= s832 "Output Types:\u{2a}" ) ) ))
...
(assert (= true (= true (= s760 "Usgage: jxml2sql \u{5b} options \u{5d} \u{5b} \u{2d}\u{2d}output output\u{2d}type \u{5d} xml\u{2d}file" ) ) ))
