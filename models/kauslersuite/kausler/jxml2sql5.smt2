...
(assert (= true (= true (= s73 "\x2exml" ) ) ))
(assert (= true (= true (= s98 s91 ) ) ))
(assert (= true (= true (= s140 s135 ) ) ))
(assert (= true (= true (= s66 "\x2d\x2d" ) ) ))
(assert (= true (= true (= s17 "output" ) ) ))
(assert (= true (= true (= s25 "version" ) ) ))
(assert (= true (= true (= s123 "libjxml2sql version: " ) ) ))
(assert (= true (= true (= s82 "\x2d\x2d" ) ) ))
(assert (= true (= true (= s89 "\x2exml" ) ) ))
(assert (= true (= true (= s49 "\x2d\x2d" ) ) ))
(assert (= true (= true (= s9 "\x2d\x2d" ) ) ))
(assert (= true (= true (= s91 "" ) ) ))
(assert (= true (= true (= s126 "0\x2e3\x2e0" ) ) ))
(assert (= true (= true (= s116 s109 ) ) ))
(assert (= true (= true (= s36 "output" ) ) ))
(assert (= true (= true (= s60 "\x2exml" ) ) ))
(assert (= true (= true (= s136 "\x2a" ) ) ))
(assert (= true (= true (= s105 "   jxml2sql version: 0\x2e2\x2e0\x2a" ) ) ))
